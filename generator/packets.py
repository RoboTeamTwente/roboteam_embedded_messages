...
packets = {
    ...
    "REM_RobotStateInfo" : [
        ...
        ["wheelSpeedRef1",      16, [-2500.,2500.], "Reference speed of Wheel_1"],
        ["wheelSpeedRef2",      16, [-2500.,2500.], "Reference speed of Wheel_2"],
        ["wheelSpeedRef3",      16, [-2500.,2500.], "Reference speed of Wheel_3"],
        ["wheelSpeedRef4",      16, [-2500.,2500.], "Reference speed of Wheel_4"],
        ["wheelController_1",   16, [-1, 1],        "Encoder data of Wheel_1"],
        ["wheelController_2",   16, [-1, 1],        "Encoder data of Wheel_2"],
        ["wheelController_3",   16, [-1, 1],        "Encoder data of Wheel_3"],
        ["wheelController_4",   16, [-1, 1],        "Encoder data of Wheel_4"],
        ["bodyController_u",    16, [-100, 100],    "Body speed in u direction"],
        ["bodyController_v",    16, [-100, 100],    "Body speed in v direction"],
        ["bodyController_w",    16, [-100, 100],    "Body speed in w direction"],
        ["bodyControllerRef_u", 16, [-100, 100],    "Body reference speed in u direction"],
        ["bodyControllerRef_v", 16, [-100, 100],    "Body reference speed in v direction"],
        ["bodyControllerRef_w", 16, [-100, 100],    "Body reference speed in w direction"]
    ],
    "REM_RobotBuzzer" : [
