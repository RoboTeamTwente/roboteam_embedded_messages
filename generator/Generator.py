...
class Generator:
	...
	def convert_type(self, variable_type:str) -> str:
		...
		"""
		return None
	def cast_to_type(self, string, variable_type:str) -> str:
		"""_summary_
	...
	def begin_block_comment(self) -> str:
		""" Generates the beginning of a block comment, such as /* or '''

		Returns:
			str: The beginning of a block comment
		"""
		raise NotImplementedError()
	def end_block_comment(self) -> str:
		""" Generates the end of a block comment, such as */ or '''

		Returns:
			str: The end of a block comment
		"""		
		raise NotImplementedError()
	def comment(self) -> str:
		""" Generates the start of a comment, such as // or #

		Returns:
			str: The start of a comment
		"""
		raise NotImplementedError()

	def get_payload_name(self, packet_name:str) -> str:
		...
		raise NotImplementedError()
	def get_payload_variable(self, packet_name:str) -> str:
	...
	def get_indent(self) -> str:
		""" Generates the indentation string, such as '    ' or '\t'. Currently only used for Python
	...
	def to_float(self) -> str:
		""" Generates the float suffix, such as 'F' or ''. Currently only used for C

		Returns:
			str: The float suffix
		"""
		return ""

	def to_begin(self, packet_name:str) -> str:
		""" Generates anything needed at the beginning of a file, such as 'import numpy' or '#include <stdint.h>'
		...
		"""
		return ""
	def to_end(self, packet_name:str) -> str:
	...
	def to_payload_instance(self, packet_name:str, variables:list[Variable]) -> str:
		""" Generates the code for the payload instance. For C, this is a struct with a uint8_t array, for Python, 
		this is not needed since it is just a numpy array
	...
	def to_instance(self, packet_name:str, variables:list[Variable]) -> str:
		""" Generates the code for the packet instance. For C, this is a struct with all variables, for Python,
		this is a class with all variables
	...
	def end_function(self) -> str:
		...
		Returns:
			str: The end of a function
		"""
		return ""

	def to_encode(self, packet_name:str, variables:list[Variable]):
