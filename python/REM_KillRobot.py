...
# ================================ ENCODE ================================
    def encode(self):
        payload = np.zeros(REM_BaseTypes.REM_PACKET_SIZE_REM_KILL_ROBOT, dtype=np.uint8)
        REM_KillRobot.set_header              (payload, self.header)
        REM_KillRobot.set_toRobotId           (payload, self.toRobotId)
        REM_KillRobot.set_toColor             (payload, self.toColor)
        REM_KillRobot.set_toBC                (payload, self.toBC)
        REM_KillRobot.set_toBS                (payload, self.toBS)
        REM_KillRobot.set_toPC                (payload, self.toPC)
        REM_KillRobot.set_fromRobotId         (payload, self.fromRobotId)
        REM_KillRobot.set_fromColor           (payload, self.fromColor)
        REM_KillRobot.set_reserved            (payload, self.reserved)
        REM_KillRobot.set_fromBS              (payload, self.fromBS)
        REM_KillRobot.set_fromPC              (payload, self.fromPC)
        REM_KillRobot.set_remVersion          (payload, self.remVersion)
        REM_KillRobot.set_messageId           (payload, self.messageId)
        REM_KillRobot.set_timestamp           (payload, self.timestamp)
        REM_KillRobot.set_payloadSize         (payload, self.payloadSize)
        return payload


# ================================ DECODE ================================
    def decode(self, payload):
        self.header           = REM_KillRobot.get_header(payload)
        self.toRobotId        = REM_KillRobot.get_toRobotId(payload)
        self.toColor          = REM_KillRobot.get_toColor(payload)
        self.toBC             = REM_KillRobot.get_toBC(payload)
        self.toBS             = REM_KillRobot.get_toBS(payload)
        self.toPC             = REM_KillRobot.get_toPC(payload)
        self.fromRobotId      = REM_KillRobot.get_fromRobotId(payload)
        self.fromColor        = REM_KillRobot.get_fromColor(payload)
        self.reserved         = REM_KillRobot.get_reserved(payload)
        self.fromBS           = REM_KillRobot.get_fromBS(payload)
        self.fromPC           = REM_KillRobot.get_fromPC(payload)
        self.remVersion       = REM_KillRobot.get_remVersion(payload)
        self.messageId        = REM_KillRobot.get_messageId(payload)
        self.timestamp        = REM_KillRobot.get_timestamp(payload)
        self.payloadSize      = REM_KillRobot.get_payloadSize(payload)
