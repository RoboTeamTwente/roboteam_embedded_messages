...
class REM_TimeStamp:
    ...
    TimeStamp = 0             # integer [0, 281474976710655] Unix TimeStamp
...
# ================================ GETTERS ================================
    ...
    @staticmethod
    def get_TimeStamp(payload):
        return ((payload[8]) << 40) | ((payload[9]) << 32) | ((payload[10]) << 24) | ((payload[11]) << 16) | ((payload[12]) << 8) | ((payload[13]));
...
# ================================ SETTERS ================================
    ...
    @staticmethod
    def set_TimeStamp(payload, TimeStamp):
        payload[8] = (TimeStamp >> 40);
        payload[9] = (TimeStamp >> 32);
        payload[10] = (TimeStamp >> 24);
        payload[11] = (TimeStamp >> 16);
        payload[12] = (TimeStamp >> 8);
        payload[13] = TimeStamp;

# ================================ ENCODE ================================
    def encode(self):
        payload = np.zeros(REM_BaseTypes.REM_PACKET_SIZE_REM_TIME_STAMP, dtype=np.uint8)
        REM_TimeStamp.set_header              (payload, self.header)
        REM_TimeStamp.set_toRobotId           (payload, self.toRobotId)
        REM_TimeStamp.set_toColor             (payload, self.toColor)
        REM_TimeStamp.set_toBC                (payload, self.toBC)
        REM_TimeStamp.set_toBS                (payload, self.toBS)
        REM_TimeStamp.set_toPC                (payload, self.toPC)
        REM_TimeStamp.set_fromRobotId         (payload, self.fromRobotId)
        REM_TimeStamp.set_fromColor           (payload, self.fromColor)
        REM_TimeStamp.set_fromBS              (payload, self.fromBS)
        REM_TimeStamp.set_fromPC              (payload, self.fromPC)
        REM_TimeStamp.set_needTimeStamp       (payload, self.needTimeStamp)
        REM_TimeStamp.set_remVersion          (payload, self.remVersion)
        REM_TimeStamp.set_messageId           (payload, self.messageId)
        REM_TimeStamp.set_timestamp           (payload, self.timestamp)
        REM_TimeStamp.set_payloadSize         (payload, self.payloadSize)
        REM_TimeStamp.set_TimeStamp           (payload, self.TimeStamp)
        return payload
...
# ================================ DECODE ================================
    def decode(self, payload):
        self.header           = REM_TimeStamp.get_header(payload)
        self.toRobotId        = REM_TimeStamp.get_toRobotId(payload)
        self.toColor          = REM_TimeStamp.get_toColor(payload)
        self.toBC             = REM_TimeStamp.get_toBC(payload)
        self.toBS             = REM_TimeStamp.get_toBS(payload)
        self.toPC             = REM_TimeStamp.get_toPC(payload)
        self.fromRobotId      = REM_TimeStamp.get_fromRobotId(payload)
        self.fromColor        = REM_TimeStamp.get_fromColor(payload)
        self.fromBS           = REM_TimeStamp.get_fromBS(payload)
        self.fromPC           = REM_TimeStamp.get_fromPC(payload)
        self.needTimeStamp    = REM_TimeStamp.get_needTimeStamp(payload)
        self.remVersion       = REM_TimeStamp.get_remVersion(payload)
        self.messageId        = REM_TimeStamp.get_messageId(payload)
        self.timestamp        = REM_TimeStamp.get_timestamp(payload)
        self.payloadSize      = REM_TimeStamp.get_payloadSize(payload)
        self.TimeStamp        = REM_TimeStamp.get_TimeStamp(payload)
