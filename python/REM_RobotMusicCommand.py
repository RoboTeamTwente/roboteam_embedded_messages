...
# ================================ GETTERS ================================
    ...
    def get_play(payload):
        return (payload[11] & 0b10000000) > 0;

    @staticmethod
    def get_pause(payload):
        return (payload[11] & 0b01000000) > 0;
    ...
    def get_volume(payload):
        return ((payload[11] & 0b00000111) << 2) | ((payload[12] & 0b11000000) >> 6);

    @staticmethod
    def get_volumeUp(payload):
        return (payload[12] & 0b00100000) > 0;

    @staticmethod
    def get_volumeDown(payload):
        return (payload[12] & 0b00010000) > 0;

    @staticmethod
    def get_folderId(payload):
        return ((payload[12] & 0b00001111));
...
# ================================ SETTERS ================================
    ...
    def set_play(payload, play):
        payload[11] = ((play << 7) & 0b10000000) | (payload[11] & 0b01111111);

    @staticmethod
    def set_pause(payload, pause):
        payload[11] = ((pause << 6) & 0b01000000) | (payload[11] & 0b10111111);

    @staticmethod
    def set_stop(payload, stop):
        payload[11] = ((stop << 5) & 0b00100000) | (payload[11] & 0b11011111);

    @staticmethod
    def set_previousSong(payload, previousSong):
        payload[11] = ((previousSong << 4) & 0b00010000) | (payload[11] & 0b11101111);

    @staticmethod
    def set_nextSong(payload, nextSong):
        payload[11] = ((nextSong << 3) & 0b00001000) | (payload[11] & 0b11110111);

    @staticmethod
    def set_volume(payload, volume):
        payload[11] = ((volume >> 2) & 0b00000111) | (payload[11] & 0b11111000);
        payload[12] = ((volume << 6) & 0b11000000) | (payload[12] & 0b00111111);

    @staticmethod
    def set_volumeUp(payload, volumeUp):
        payload[12] = ((volumeUp << 5) & 0b00100000) | (payload[12] & 0b11011111);

    @staticmethod
    def set_volumeDown(payload, volumeDown):
        payload[12] = ((volumeDown << 4) & 0b00010000) | (payload[12] & 0b11101111);

    @staticmethod
    def set_folderId(payload, folderId):
        payload[12] = (folderId & 0b00001111) | (payload[12] & 0b11110000);
...
# ================================ ENCODE ================================
    def encode(self):
        ...
        REM_RobotMusicCommand.set_packetType          (payload, self.packetType)
...
# ================================ DECODE ================================
    def decode(self, payload):
        self.packetType       = REM_RobotMusicCommand.get_packetType(payload)
