...
# ================================ GETTERS ================================
    ...
    def get_play(payload):
        return (payload[9] & 0b10000000) > 0;

    @staticmethod
    def get_pause(payload):
        return (payload[9] & 0b01000000) > 0;
    ...
    def get_nextSong(payload):
        return (payload[9] & 0b00001000) > 0;

    @staticmethod
    def get_volume(payload):
        return ((payload[9] & 0b00000111) << 2) | ((payload[10] & 0b11000000) >> 6);
...
# ================================ SETTERS ================================
    ...
    def set_play(payload, play):
        payload[9] = ((play << 7) & 0b10000000) | (payload[9] & 0b01111111);

    @staticmethod
    def set_pause(payload, pause):
        payload[9] = ((pause << 6) & 0b01000000) | (payload[9] & 0b10111111);

    @staticmethod
    def set_stop(payload, stop):
        payload[9] = ((stop << 5) & 0b00100000) | (payload[9] & 0b11011111);

    @staticmethod
    def set_previousSong(payload, previousSong):
        payload[9] = ((previousSong << 4) & 0b00010000) | (payload[9] & 0b11101111);

    @staticmethod
    def set_nextSong(payload, nextSong):
        payload[9] = ((nextSong << 3) & 0b00001000) | (payload[9] & 0b11110111);

    @staticmethod
    def set_volume(payload, volume):
        payload[9] = ((volume >> 2) & 0b00000111) | (payload[9] & 0b11111000);
        payload[10] = ((volume << 6) & 0b11000000) | (payload[10] & 0b00111111);

    @staticmethod
    def set_volumeUp(payload, volumeUp):
        payload[10] = ((volumeUp << 5) & 0b00100000) | (payload[10] & 0b11011111);

    @staticmethod
    def set_volumeDown(payload, volumeDown):
        payload[10] = ((volumeDown << 4) & 0b00010000) | (payload[10] & 0b11101111);

    @staticmethod
    def set_folderId(payload, folderId):
        payload[10] = (folderId & 0b00001111) | (payload[10] & 0b11110000);
