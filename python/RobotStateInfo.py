...
# ================================ ENCODE ================================
    def encode(self):
        ...
        RobotStateInfo.set_wheel1Integral      (payload, self.wheel1Integral)
        RobotStateInfo.set_wheel2Integral      (payload, self.wheel2Integral)
        RobotStateInfo.set_wheel3Integral      (payload, self.wheel3Integral)
        RobotStateInfo.set_wheel4Integral      (payload, self.wheel4Integral)
        return payload
...
# ================================ DECODE ================================
    def decode(self, payload):
        ...
        self.wheel1Integral   = RobotStateInfo.get_wheel1Integral(payload)
        self.wheel2Integral   = RobotStateInfo.get_wheel2Integral(payload)
        self.wheel3Integral   = RobotStateInfo.get_wheel3Integral(payload)
        self.wheel4Integral   = RobotStateInfo.get_wheel4Integral(payload)
