...
# ================================ GETTERS ================================
    ...
    def get_dribbler(payload):
        _dribbler = ((payload[20] & 0b00111000) >> 3);
    ...
    def get_kickChipPower(payload):
        _kickChipPower = ((payload[21] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_dribbler(payload, dribbler):
        ...
        payload[20] = ((_dribbler << 3) & 0b00111000) | (payload[20] & 0b11000111);

    @staticmethod
    def set_doKick(payload, doKick):
        payload[20] = ((doKick << 2) & 0b00000100) | (payload[20] & 0b11111011);

    @staticmethod
    def set_doChip(payload, doChip):
        payload[20] = ((doChip << 1) & 0b00000010) | (payload[20] & 0b11111101);

    @staticmethod
    def set_kickAtAngle(payload, kickAtAngle):
        payload[20] = (kickAtAngle & 0b00000001) | (payload[20] & 0b11111110);

    @staticmethod
    def set_kickChipPower(payload, kickChipPower):
        _kickChipPower = int(kickChipPower / 0.4333333333333333);
        payload[21] = ((_kickChipPower << 4) & 0b11110000) | (payload[21] & 0b00001111);

    @staticmethod
    def set_doForce(payload, doForce):
        payload[21] = ((doForce << 3) & 0b00001000) | (payload[21] & 0b11110111);

    @staticmethod
    def set_feedback(payload, feedback):
        payload[21] = ((feedback << 2) & 0b00000100) | (payload[21] & 0b11111011);
