...
# ================================ GETTERS ================================
    ...
    def get_reboot(payload):
        return (payload[24] & 0b10000000) > 0;
...
# ================================ SETTERS ================================
    ...
    def set_dribbler(payload, dribbler):
        ...
        payload[21] = _dribbler;

    @staticmethod
    def set_kickChipPower(payload, kickChipPower):
        _kickChipPower = int(kickChipPower / 0.0254901960784314);
        payload[22] = _kickChipPower;

    @staticmethod
    def set_doKick(payload, doKick):
        payload[23] = ((doKick << 7) & 0b10000000) | (payload[23] & 0b01111111);

    @staticmethod
    def set_doChip(payload, doChip):
        payload[23] = ((doChip << 6) & 0b01000000) | (payload[23] & 0b10111111);

    @staticmethod
    def set_kickAtYaw(payload, kickAtYaw):
        payload[23] = ((kickAtYaw << 5) & 0b00100000) | (payload[23] & 0b11011111);

    @staticmethod
    def set_doForce(payload, doForce):
        payload[23] = ((doForce << 4) & 0b00010000) | (payload[23] & 0b11101111);

    @staticmethod
    def set_useCameraAngle(payload, useCameraAngle):
        payload[23] = ((useCameraAngle << 3) & 0b00001000) | (payload[23] & 0b11110111);

    @staticmethod
    def set_useYaw(payload, useYaw):
        payload[23] = ((useYaw << 2) & 0b00000100) | (payload[23] & 0b11111011);
    ...
    def set_feedback(payload, feedback):
        payload[23] = (feedback & 0b00000001) | (payload[23] & 0b11111110);

    @staticmethod
    def set_reboot(payload, reboot):
        payload[24] = ((reboot << 7) & 0b10000000) | (payload[24] & 0b01111111);
