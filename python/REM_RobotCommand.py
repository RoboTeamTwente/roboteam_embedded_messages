...
# ================================ GETTERS ================================
    ...
    def get_doChip(payload):
        return (payload[22] & 0b01000000) > 0;
    ...
    def get_useYaw(payload):
        return (payload[22] & 0b00000100) > 0;

    @staticmethod
    def get_dribblerOn(payload):
        return (payload[22] & 0b00000010) > 0;

    @staticmethod
    def get_dribblerOption1(payload):
        return (payload[22] & 0b00000001) > 0;

    @staticmethod
    def get_dribblerOption2(payload):
        return (payload[23] & 0b10000000) > 0;

    @staticmethod
    def get_dribblerOption3(payload):
        return (payload[23] & 0b01000000) > 0;

    @staticmethod
    def get_dribblerOption4(payload):
        return (payload[23] & 0b00100000) > 0;

    @staticmethod
    def get_dribblerOption5(payload):
        return (payload[23] & 0b00010000) > 0;
    ...
    def get_wheelsOff(payload):
        return (payload[23] & 0b00000010) > 0;

    @staticmethod
    def get_reboot(payload):
        return (payload[23] & 0b00000001) > 0;
...
# ================================ SETTERS ================================
    ...
    def set_kickChipPower(payload, kickChipPower):
        ...
        payload[21] = _kickChipPower;

    @staticmethod
    def set_doKick(payload, doKick):
        payload[22] = ((doKick << 7) & 0b10000000) | (payload[22] & 0b01111111);

    @staticmethod
    def set_doChip(payload, doChip):
        payload[22] = ((doChip << 6) & 0b01000000) | (payload[22] & 0b10111111);

    @staticmethod
    def set_kickAtYaw(payload, kickAtYaw):
        payload[22] = ((kickAtYaw << 5) & 0b00100000) | (payload[22] & 0b11011111);
    ...
    def set_useYaw(payload, useYaw):
        payload[22] = ((useYaw << 2) & 0b00000100) | (payload[22] & 0b11111011);

    @staticmethod
    def set_dribblerOn(payload, dribblerOn):
        payload[22] = ((dribblerOn << 1) & 0b00000010) | (payload[22] & 0b11111101);

    @staticmethod
    def set_dribblerOption1(payload, dribblerOption1):
        payload[22] = (dribblerOption1 & 0b00000001) | (payload[22] & 0b11111110);

    @staticmethod
    def set_dribblerOption2(payload, dribblerOption2):
        payload[23] = ((dribblerOption2 << 7) & 0b10000000) | (payload[23] & 0b01111111);

    @staticmethod
    def set_dribblerOption3(payload, dribblerOption3):
        payload[23] = ((dribblerOption3 << 6) & 0b01000000) | (payload[23] & 0b10111111);

    @staticmethod
    def set_dribblerOption4(payload, dribblerOption4):
        payload[23] = ((dribblerOption4 << 5) & 0b00100000) | (payload[23] & 0b11011111);

    @staticmethod
    def set_dribblerOption5(payload, dribblerOption5):
        payload[23] = ((dribblerOption5 << 4) & 0b00010000) | (payload[23] & 0b11101111);
    ...
    def set_wheelsOff(payload, wheelsOff):
        payload[23] = ((wheelsOff << 1) & 0b00000010) | (payload[23] & 0b11111101);

    @staticmethod
    def set_reboot(payload, reboot):
        payload[23] = (reboot & 0b00000001) | (payload[23] & 0b11111110);
