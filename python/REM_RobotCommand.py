...
class REM_RobotCommand:
    ...
    acceleration_magnitude = 0 # float   [-15.000, 15.000]    Magnitude of acceleration (m/s^2)
    acceleration_angle = 0    # float   [-3.142, 3.142]      Angle of acceleration (rad)
...
# ================================ GETTERS ================================
    ...
    @staticmethod
    def get_acceleration_magnitude(payload):
        _acceleration_magnitude = ((payload[21]) << 8) | ((payload[22]));
        return (_acceleration_magnitude * 0.0004577706569009) + -15.0000000000000000;

    @staticmethod
    def get_acceleration_angle(payload):
        _acceleration_angle = ((payload[23]) << 8) | ((payload[24]));
        return (_acceleration_angle * 0.0000958752621833) + -3.1415926535897931;

    @staticmethod
    def get_kickChipPower(payload):
        _kickChipPower = ((payload[25]));
        return (_kickChipPower * 0.0313725490196078);

    @staticmethod
    def get_doKick(payload):
        return (payload[26] & 0b10000000) > 0;

    @staticmethod
    def get_doChip(payload):
        return (payload[26] & 0b01000000) > 0;

    @staticmethod
    def get_kickAtYaw(payload):
        return (payload[26] & 0b00100000) > 0;

    @staticmethod
    def get_doForce(payload):
        return (payload[26] & 0b00010000) > 0;

    @staticmethod
    def get_useCameraYaw(payload):
        return (payload[26] & 0b00001000) > 0;

    @staticmethod
    def get_useYaw(payload):
        return (payload[26] & 0b00000100) > 0;

    @staticmethod
    def get_dribblerOn(payload):
        return (payload[26] & 0b00000010) > 0;

    @staticmethod
    def get_dribblerOption1(payload):
        return (payload[26] & 0b00000001) > 0;

    @staticmethod
    def get_dribblerOption2(payload):
        return (payload[27] & 0b10000000) > 0;

    @staticmethod
    def get_dribblerOption3(payload):
        return (payload[27] & 0b01000000) > 0;

    @staticmethod
    def get_dribblerOption4(payload):
        return (payload[27] & 0b00100000) > 0;

    @staticmethod
    def get_dribblerOption5(payload):
        return (payload[27] & 0b00010000) > 0;

    @staticmethod
    def get_dribblerOption6(payload):
        return (payload[27] & 0b00001000) > 0;

    @staticmethod
    def get_sendStateInfo(payload):
        return (payload[27] & 0b00000100) > 0;

    @staticmethod
    def get_wheelsOff(payload):
        return (payload[27] & 0b00000010) > 0;

    @staticmethod
    def get_reboot(payload):
        return (payload[27] & 0b00000001) > 0;
...
# ================================ SETTERS ================================
    ...
    @staticmethod
    def set_acceleration_magnitude(payload, acceleration_magnitude):
        _acceleration_magnitude = int((acceleration_magnitude +15.0000000000000000) / 0.0004577706569009);
        payload[21] = (_acceleration_magnitude >> 8);
        payload[22] = _acceleration_magnitude;

    @staticmethod
    def set_acceleration_angle(payload, acceleration_angle):
        _acceleration_angle = int((acceleration_angle +3.1415926535897931) / 0.0000958752621833);
        payload[23] = (_acceleration_angle >> 8);
        payload[24] = _acceleration_angle;

    @staticmethod
    def set_kickChipPower(payload, kickChipPower):
        _kickChipPower = int(kickChipPower / 0.0313725490196078);
        payload[25] = _kickChipPower;

    @staticmethod
    def set_doKick(payload, doKick):
        payload[26] = ((doKick << 7) & 0b10000000) | (payload[26] & 0b01111111);

    @staticmethod
    def set_doChip(payload, doChip):
        payload[26] = ((doChip << 6) & 0b01000000) | (payload[26] & 0b10111111);

    @staticmethod
    def set_kickAtYaw(payload, kickAtYaw):
        payload[26] = ((kickAtYaw << 5) & 0b00100000) | (payload[26] & 0b11011111);

    @staticmethod
    def set_doForce(payload, doForce):
        payload[26] = ((doForce << 4) & 0b00010000) | (payload[26] & 0b11101111);

    @staticmethod
    def set_useCameraYaw(payload, useCameraYaw):
        payload[26] = ((useCameraYaw << 3) & 0b00001000) | (payload[26] & 0b11110111);

    @staticmethod
    def set_useYaw(payload, useYaw):
        payload[26] = ((useYaw << 2) & 0b00000100) | (payload[26] & 0b11111011);

    @staticmethod
    def set_dribblerOn(payload, dribblerOn):
        payload[26] = ((dribblerOn << 1) & 0b00000010) | (payload[26] & 0b11111101);

    @staticmethod
    def set_dribblerOption1(payload, dribblerOption1):
        payload[26] = (dribblerOption1 & 0b00000001) | (payload[26] & 0b11111110);

    @staticmethod
    def set_dribblerOption2(payload, dribblerOption2):
        payload[27] = ((dribblerOption2 << 7) & 0b10000000) | (payload[27] & 0b01111111);

    @staticmethod
    def set_dribblerOption3(payload, dribblerOption3):
        payload[27] = ((dribblerOption3 << 6) & 0b01000000) | (payload[27] & 0b10111111);

    @staticmethod
    def set_dribblerOption4(payload, dribblerOption4):
        payload[27] = ((dribblerOption4 << 5) & 0b00100000) | (payload[27] & 0b11011111);

    @staticmethod
    def set_dribblerOption5(payload, dribblerOption5):
        payload[27] = ((dribblerOption5 << 4) & 0b00010000) | (payload[27] & 0b11101111);

    @staticmethod
    def set_dribblerOption6(payload, dribblerOption6):
        payload[27] = ((dribblerOption6 << 3) & 0b00001000) | (payload[27] & 0b11110111);

    @staticmethod
    def set_sendStateInfo(payload, sendStateInfo):
        payload[27] = ((sendStateInfo << 2) & 0b00000100) | (payload[27] & 0b11111011);

    @staticmethod
    def set_wheelsOff(payload, wheelsOff):
        payload[27] = ((wheelsOff << 1) & 0b00000010) | (payload[27] & 0b11111101);

    @staticmethod
    def set_reboot(payload, reboot):
        payload[27] = (reboot & 0b00000001) | (payload[27] & 0b11111110);
...
# ================================ ENCODE ================================
    def encode(self):
        ...
        REM_RobotCommand.set_acceleration_magnitude(payload, self.acceleration_magnitude)
        REM_RobotCommand.set_acceleration_angle  (payload, self.acceleration_angle)
...
# ================================ DECODE ================================
    def decode(self, payload):
        ...
        self.acceleration_magnitude= REM_RobotCommand.get_acceleration_magnitude(payload)
        self.acceleration_angle= REM_RobotCommand.get_acceleration_angle(payload)
