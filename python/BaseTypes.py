...
PACKET_SIZE_ROBOT_STATE_INFO                                 = 39
...
PACKET_TYPE_CONFIGURATION                                    = 0b01011010 # 90 
PACKET_SIZE_CONFIGURATION                                    = 32
PACKET_RANGE_CONFIGURATION__PBODY_X_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__PBODY_X_MAX                      = 40.
PACKET_RANGE_CONFIGURATION__PBODY_X_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__IBODY_X_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__IBODY_X_MAX                      = 20.
PACKET_RANGE_CONFIGURATION__IBODY_X_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__DBODY_X_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__DBODY_X_MAX                      = 10.
PACKET_RANGE_CONFIGURATION__DBODY_X_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__PBODY_Y_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__PBODY_Y_MAX                      = 40.
PACKET_RANGE_CONFIGURATION__PBODY_Y_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__IBODY_Y_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__IBODY_Y_MAX                      = 20.
PACKET_RANGE_CONFIGURATION__IBODY_Y_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__DBODY_Y_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__DBODY_Y_MAX                      = 10.
PACKET_RANGE_CONFIGURATION__DBODY_Y_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__PBODY_W_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__PBODY_W_MAX                      = 40.
PACKET_RANGE_CONFIGURATION__PBODY_W_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__IBODY_W_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__IBODY_W_MAX                      = 20.
PACKET_RANGE_CONFIGURATION__IBODY_W_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__DBODY_W_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__DBODY_W_MAX                      = 10.
PACKET_RANGE_CONFIGURATION__DBODY_W_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__PBODY_YAW_MIN                    = 0.
PACKET_RANGE_CONFIGURATION__PBODY_YAW_MAX                    = 40.
PACKET_RANGE_CONFIGURATION__PBODY_YAW_N_BITS                 = 16
PACKET_RANGE_CONFIGURATION__IBODY_YAW_MIN                    = 0.
PACKET_RANGE_CONFIGURATION__IBODY_YAW_MAX                    = 20.
PACKET_RANGE_CONFIGURATION__IBODY_YAW_N_BITS                 = 16
PACKET_RANGE_CONFIGURATION__DBODY_YAW_MIN                    = 0.
PACKET_RANGE_CONFIGURATION__DBODY_YAW_MAX                    = 10.
PACKET_RANGE_CONFIGURATION__DBODY_YAW_N_BITS                 = 16
PACKET_RANGE_CONFIGURATION__PWHEELS_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__PWHEELS_MAX                      = 40.
PACKET_RANGE_CONFIGURATION__PWHEELS_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__IWHEELS_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__IWHEELS_MAX                      = 20.
PACKET_RANGE_CONFIGURATION__IWHEELS_N_BITS                   = 16
PACKET_RANGE_CONFIGURATION__DWHEELS_MIN                      = 0.
PACKET_RANGE_CONFIGURATION__DWHEELS_MAX                      = 10.
PACKET_RANGE_CONFIGURATION__DWHEELS_N_BITS                   = 16
