...
# ================================ SETTERS ================================
    ...
    def set_channel(payload, channel):
        payload[11] = ((channel << 7) & 0b10000000) | (payload[11] & 0b01111111);

# ================================ ENCODE ================================
    def encode(self):
        payload = np.zeros(REM_BaseTypes.REM_PACKET_SIZE_REM_BASESTATION_CONFIGURATION, dtype=np.uint8)
        REM_BasestationConfiguration.set_packetType          (payload, self.packetType)
...
# ================================ DECODE ================================
    def decode(self, payload):
        self.packetType       = REM_BasestationConfiguration.get_packetType(payload)
