...
# ================================ SETTERS ================================
    ...
    def set_xsensYaw(payload, xsensYaw):
        ...
        payload[14] = (_xsensYaw >> 24);
        payload[15] = (_xsensYaw >> 16);
        payload[16] = (_xsensYaw >> 8);
        payload[17] = _xsensYaw;

    @staticmethod
    def set_rateOfTurn(payload, rateOfTurn):
        _rateOfTurn = int((rateOfTurn +20.0000000000000000) / 0.0006103608758679);
        payload[18] = (_rateOfTurn >> 8);
        payload[19] = _rateOfTurn;
    ...
    def set_filteredDribbleSpeed(payload, filteredDribbleSpeed):
        ...
        payload[30] = (_filteredDribbleSpeed >> 8);
        payload[31] = _filteredDribbleSpeed;
    ...
    def set_bodyController_u(payload, bodyController_u):
        ...
        payload[50] = (_bodyController_u >> 8);
        payload[51] = _bodyController_u;
    ...
    def set_bodyController_v(payload, bodyController_v):
        ...
        payload[52] = (_bodyController_v >> 8);
        payload[53] = _bodyController_v;
    ...
    def set_bodyController_w(payload, bodyController_w):
        ...
        payload[54] = (_bodyController_w >> 8);
        payload[55] = _bodyController_w;
