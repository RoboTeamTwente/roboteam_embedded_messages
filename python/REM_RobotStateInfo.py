...
# ================================ GETTERS ================================
    ...
    def get_kickerVoltage(payload):
        return ((payload[57]) << 2) | ((payload[58] & 0b11000000) >> 6);

    @staticmethod
    def get_unused(payload):
        return ((payload[58] & 0b00111111));
...
# ================================ SETTERS ================================
    ...
    def set_kickerVoltage(payload, kickerVoltage):
        payload[57] = (kickerVoltage >> 2);
        payload[58] = ((kickerVoltage << 6) & 0b11000000) | (payload[58] & 0b00111111);

    @staticmethod
    def set_unused(payload, unused):
        payload[58] = (unused & 0b00111111) | (payload[58] & 0b11000000);
