...
class REM_RobotStateInfo:
    ...
    wheelController_1 = 0     # float   [-1.000, 1.000]      Encoder data of Wheel_1
    wheelController_2 = 0     # float   [-1.000, 1.000]      Encoder data of Wheel_2
    wheelController_3 = 0     # float   [-1.000, 1.000]      Encoder data of Wheel_3
    wheelController_4 = 0     # float   [-1.000, 1.000]      Encoder data of Wheel_4
    bodyController_u = 0      # float   [-100.000, 100.000]  Body speed in u direction
    bodyController_v = 0      # float   [-100.000, 100.000]  Body speed in v direction
    bodyController_w = 0      # float   [-100.000, 100.000]  Body speed in w direction
    bodyControllerRef_u = 0   # float   [-100.000, 100.000]  Body reference speed in u direction
    bodyControllerRef_v = 0   # float   [-100.000, 100.000]  Body reference speed in v direction
    bodyControllerRef_w = 0   # float   [-100.000, 100.000]  Body reference speed in w direction
