...
class PIDConfiguration:
    ...
    PbodyX = 0                # float   [0.000, 40.000]      P gain of the PID for body_x (x-direction)
    IbodyX = 0                # float   [0.000, 20.000]      I gain of the PID for body_x (x-direction)
    DbodyX = 0                # float   [0.000, 10.000]      D gain of the PID for body_x (x-direction)
    PbodyY = 0                # float   [0.000, 40.000]      P gain of the PID for body_y (y-direction)
    IbodyY = 0                # float   [0.000, 20.000]      I gain of the PID for body_y (y-direction)
    DbodyY = 0                # float   [0.000, 10.000]      D gain of the PID for body_y (y-direction)
...
# ================================ ENCODE ================================
    def encode(self):
        ...
        PIDConfiguration.set_PbodyX              (payload, self.PbodyX)
        PIDConfiguration.set_IbodyX              (payload, self.IbodyX)
        PIDConfiguration.set_DbodyX              (payload, self.DbodyX)
        PIDConfiguration.set_PbodyY              (payload, self.PbodyY)
        PIDConfiguration.set_IbodyY              (payload, self.IbodyY)
        PIDConfiguration.set_DbodyY              (payload, self.DbodyY)
        PIDConfiguration.set_PbodyW              (payload, self.PbodyW)
        PIDConfiguration.set_IbodyW              (payload, self.IbodyW)
        PIDConfiguration.set_DbodyW              (payload, self.DbodyW)
        PIDConfiguration.set_PbodyYaw            (payload, self.PbodyYaw)
        PIDConfiguration.set_IbodyYaw            (payload, self.IbodyYaw)
        PIDConfiguration.set_DbodyYaw            (payload, self.DbodyYaw)
        PIDConfiguration.set_Pwheels             (payload, self.Pwheels)
        PIDConfiguration.set_Iwheels             (payload, self.Iwheels)
        PIDConfiguration.set_Dwheels             (payload, self.Dwheels)
        return payload


# ================================ DECODE ================================
    def decode(self, payload):
        self.header           = PIDConfiguration.get_header(payload)
        self.remVersion       = PIDConfiguration.get_remVersion(payload)
        self.id               = PIDConfiguration.get_id(payload)
        self.PbodyX           = PIDConfiguration.get_PbodyX(payload)
        self.IbodyX           = PIDConfiguration.get_IbodyX(payload)
        self.DbodyX           = PIDConfiguration.get_DbodyX(payload)
        self.PbodyY           = PIDConfiguration.get_PbodyY(payload)
        self.IbodyY           = PIDConfiguration.get_IbodyY(payload)
        self.DbodyY           = PIDConfiguration.get_DbodyY(payload)
        self.PbodyW           = PIDConfiguration.get_PbodyW(payload)
        self.IbodyW           = PIDConfiguration.get_IbodyW(payload)
        self.DbodyW           = PIDConfiguration.get_DbodyW(payload)
        self.PbodyYaw         = PIDConfiguration.get_PbodyYaw(payload)
        self.IbodyYaw         = PIDConfiguration.get_IbodyYaw(payload)
        self.DbodyYaw         = PIDConfiguration.get_DbodyYaw(payload)
        self.Pwheels          = PIDConfiguration.get_Pwheels(payload)
        self.Iwheels          = PIDConfiguration.get_Iwheels(payload)
        self.Dwheels          = PIDConfiguration.get_Dwheels(payload)
