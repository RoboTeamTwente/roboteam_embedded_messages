...
# ================================ ENCODE ================================
    def encode(self):
        payload = np.zeros(REM_BaseTypes.PACKET_SIZE_REM_P_I_D_CONFIGURATION, dtype=np.uint8)
        REM_PIDConfiguration.set_header              (payload, self.header)
        REM_PIDConfiguration.set_remVersion          (payload, self.remVersion)
        REM_PIDConfiguration.set_id                  (payload, self.id)
        REM_PIDConfiguration.set_PbodyX              (payload, self.PbodyX)
        REM_PIDConfiguration.set_IbodyX              (payload, self.IbodyX)
        REM_PIDConfiguration.set_DbodyX              (payload, self.DbodyX)
        REM_PIDConfiguration.set_PbodyY              (payload, self.PbodyY)
        REM_PIDConfiguration.set_IbodyY              (payload, self.IbodyY)
        REM_PIDConfiguration.set_DbodyY              (payload, self.DbodyY)
        REM_PIDConfiguration.set_PbodyW              (payload, self.PbodyW)
        REM_PIDConfiguration.set_IbodyW              (payload, self.IbodyW)
        REM_PIDConfiguration.set_DbodyW              (payload, self.DbodyW)
        REM_PIDConfiguration.set_PbodyYaw            (payload, self.PbodyYaw)
        REM_PIDConfiguration.set_IbodyYaw            (payload, self.IbodyYaw)
        REM_PIDConfiguration.set_DbodyYaw            (payload, self.DbodyYaw)
        REM_PIDConfiguration.set_Pwheels             (payload, self.Pwheels)
        REM_PIDConfiguration.set_Iwheels             (payload, self.Iwheels)
        REM_PIDConfiguration.set_Dwheels             (payload, self.Dwheels)
        return payload


# ================================ DECODE ================================
    def decode(self, payload):
        self.header           = REM_PIDConfiguration.get_header(payload)
        self.remVersion       = REM_PIDConfiguration.get_remVersion(payload)
        self.id               = REM_PIDConfiguration.get_id(payload)
        self.PbodyX           = REM_PIDConfiguration.get_PbodyX(payload)
        self.IbodyX           = REM_PIDConfiguration.get_IbodyX(payload)
        self.DbodyX           = REM_PIDConfiguration.get_DbodyX(payload)
        self.PbodyY           = REM_PIDConfiguration.get_PbodyY(payload)
        self.IbodyY           = REM_PIDConfiguration.get_IbodyY(payload)
        self.DbodyY           = REM_PIDConfiguration.get_DbodyY(payload)
        self.PbodyW           = REM_PIDConfiguration.get_PbodyW(payload)
        self.IbodyW           = REM_PIDConfiguration.get_IbodyW(payload)
        self.DbodyW           = REM_PIDConfiguration.get_DbodyW(payload)
        self.PbodyYaw         = REM_PIDConfiguration.get_PbodyYaw(payload)
        self.IbodyYaw         = REM_PIDConfiguration.get_IbodyYaw(payload)
        self.DbodyYaw         = REM_PIDConfiguration.get_DbodyYaw(payload)
        self.Pwheels          = REM_PIDConfiguration.get_Pwheels(payload)
        self.Iwheels          = REM_PIDConfiguration.get_Iwheels(payload)
        self.Dwheels          = REM_PIDConfiguration.get_Dwheels(payload)
