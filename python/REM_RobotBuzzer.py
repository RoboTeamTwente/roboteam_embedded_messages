...
# ================================ GETTERS ================================
    ...
    def get_period(payload):
        return ((payload[9]) << 4) | ((payload[10] & 0b11110000) >> 4);

    @staticmethod
    def get_duration(payload):
        _duration = ((payload[10] & 0b00001111) << 12) | ((payload[11]) << 4) | ((payload[12] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_period(payload, period):
        payload[9] = (period >> 4);
        payload[10] = ((period << 4) & 0b11110000) | (payload[10] & 0b00001111);

    @staticmethod
    def set_duration(payload, duration):
        _duration = int(duration / 0.0000762951094835);
        payload[10] = ((_duration >> 12) & 0b00001111) | (payload[10] & 0b11110000);
        payload[11] = (_duration >> 4);
        payload[12] = ((_duration << 4) & 0b11110000) | (payload[12] & 0b00001111);
