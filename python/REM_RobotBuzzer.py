...
# ================================ GETTERS ================================
    ...
    def get_period(payload):
        return ((payload[11]) << 4) | ((payload[12] & 0b11110000) >> 4);

    @staticmethod
    def get_duration(payload):
        _duration = ((payload[12] & 0b00001111) << 12) | ((payload[13]) << 4) | ((payload[14] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_period(payload, period):
        payload[11] = (period >> 4);
        payload[12] = ((period << 4) & 0b11110000) | (payload[12] & 0b00001111);

    @staticmethod
    def set_duration(payload, duration):
        _duration = int(duration / 0.0000762951094835);
        payload[12] = ((_duration >> 12) & 0b00001111) | (payload[12] & 0b11110000);
        payload[13] = (_duration >> 4);
        payload[14] = ((_duration << 4) & 0b11110000) | (payload[14] & 0b00001111);

# ================================ ENCODE ================================
    def encode(self):
        payload = np.zeros(REM_BaseTypes.REM_PACKET_SIZE_REM_ROBOT_BUZZER, dtype=np.uint8)
        REM_RobotBuzzer.set_packetType          (payload, self.packetType)
...
# ================================ DECODE ================================
    def decode(self, payload):
        self.packetType       = REM_RobotBuzzer.get_packetType(payload)
