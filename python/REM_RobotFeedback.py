...
class REM_RobotFeedback:
    ...
    filler = 0                # integer [0, 18014398509481983] filler bits to have equal or more bytes than REM_RobotCommand
...
# ================================ GETTERS ================================
    ...
    def get_batteryLevel(payload):
        _batteryLevel = ((payload[17]) << 8) | ((payload[18]));
        return (_batteryLevel * 0.0002288853284504) + 15.0000000000000000;

    @staticmethod
    def get_XsensCalibrated(payload):
        return (payload[19] & 0b10000000) > 0;

    @staticmethod
    def get_ballSensorWorking(payload):
        return (payload[19] & 0b01000000) > 0;

    @staticmethod
    def get_ballSensorSeesBall(payload):
        return (payload[19] & 0b00100000) > 0;

    @staticmethod
    def get_dribblerSeesBall(payload):
        return (payload[19] & 0b00010000) > 0;
    ...
    def get_capacitorCharged(payload):
        return (payload[19] & 0b00000010) > 0;

    @staticmethod
    def get_reserved1(payload):
        return (payload[19] & 0b00000001) > 0;

    @staticmethod
    def get_kickerVoltage(payload):
        return ((payload[20]) << 2) | ((payload[21] & 0b11000000) >> 6);

    @staticmethod
    def get_filler(payload):
        return ((payload[21] & 0b00111111) << 48) | ((payload[22]) << 40) | ((payload[23]) << 32) | ((payload[24]) << 24) | ((payload[25]) << 16) | ((payload[26]) << 8) | ((payload[27]));
...
# ================================ SETTERS ================================
    ...
    def set_batteryLevel(payload, batteryLevel):
        _batteryLevel = int((batteryLevel -15.0000000000000000) / 0.0002288853284504);
        payload[17] = (_batteryLevel >> 8);
        payload[18] = _batteryLevel;

    @staticmethod
    def set_XsensCalibrated(payload, XsensCalibrated):
        payload[19] = ((XsensCalibrated << 7) & 0b10000000) | (payload[19] & 0b01111111);

    @staticmethod
    def set_ballSensorWorking(payload, ballSensorWorking):
        payload[19] = ((ballSensorWorking << 6) & 0b01000000) | (payload[19] & 0b10111111);

    @staticmethod
    def set_ballSensorSeesBall(payload, ballSensorSeesBall):
        payload[19] = ((ballSensorSeesBall << 5) & 0b00100000) | (payload[19] & 0b11011111);

    @staticmethod
    def set_dribblerSeesBall(payload, dribblerSeesBall):
        payload[19] = ((dribblerSeesBall << 4) & 0b00010000) | (payload[19] & 0b11101111);

    @staticmethod
    def set_kickerFault(payload, kickerFault):
        payload[19] = ((kickerFault << 3) & 0b00001000) | (payload[19] & 0b11110111);

    @staticmethod
    def set_kickerOn(payload, kickerOn):
        payload[19] = ((kickerOn << 2) & 0b00000100) | (payload[19] & 0b11111011);

    @staticmethod
    def set_capacitorCharged(payload, capacitorCharged):
        payload[19] = ((capacitorCharged << 1) & 0b00000010) | (payload[19] & 0b11111101);

    @staticmethod
    def set_reserved1(payload, reserved1):
        payload[19] = (reserved1 & 0b00000001) | (payload[19] & 0b11111110);

    @staticmethod
    def set_kickerVoltage(payload, kickerVoltage):
        payload[20] = (kickerVoltage >> 2);
        payload[21] = ((kickerVoltage << 6) & 0b11000000) | (payload[21] & 0b00111111);

    @staticmethod
    def set_filler(payload, filler):
        payload[21] = ((filler >> 48) & 0b00111111) | (payload[21] & 0b11000000);
        payload[22] = (filler >> 40);
        payload[23] = (filler >> 32);
        payload[24] = (filler >> 24);
        payload[25] = (filler >> 16);
        payload[26] = (filler >> 8);
        payload[27] = filler;
...
# ================================ ENCODE ================================
    def encode(self):
        ...
        REM_RobotFeedback.set_kickerVoltage       (payload, self.kickerVoltage)
        REM_RobotFeedback.set_filler              (payload, self.filler)
        return payload
...
# ================================ DECODE ================================
    def decode(self, payload):
        ...
        self.kickerVoltage    = REM_RobotFeedback.get_kickerVoltage(payload)
        self.filler           = REM_RobotFeedback.get_filler(payload)
