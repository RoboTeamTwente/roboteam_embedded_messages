...
# ================================ GETTERS ================================
    ...
    def get_ballPos(payload):
        _ballPos = ((payload[17] & 0b11110000) >> 4);
    ...
    def get_reserved1(payload):
        return ((payload[17] & 0b00000111));

    @staticmethod
    def get_wheelLocked(payload):
        return ((payload[18] & 0b11110000) >> 4);

    @staticmethod
    def get_wheelBraking(payload):
        return ((payload[18] & 0b00001111));
...
# ================================ SETTERS ================================
    ...
    def set_batteryLevel(payload, batteryLevel):
        payload[16] = ((batteryLevel << 4) & 0b11110000) | (payload[16] & 0b00001111);

    @staticmethod
    def set_XsensCalibrated(payload, XsensCalibrated):
        payload[16] = ((XsensCalibrated << 3) & 0b00001000) | (payload[16] & 0b11110111);

    @staticmethod
    def set_capacitorCharged(payload, capacitorCharged):
        payload[16] = ((capacitorCharged << 2) & 0b00000100) | (payload[16] & 0b11111011);

    @staticmethod
    def set_ballSensorWorking(payload, ballSensorWorking):
        payload[16] = ((ballSensorWorking << 1) & 0b00000010) | (payload[16] & 0b11111101);

    @staticmethod
    def set_ballSensorSeesBall(payload, ballSensorSeesBall):
        payload[16] = (ballSensorSeesBall & 0b00000001) | (payload[16] & 0b11111110);

    @staticmethod
    def set_ballPos(payload, ballPos):
        _ballPos = int((ballPos +0.5000000000000000) / 0.0666666666666667);
        payload[17] = ((_ballPos << 4) & 0b11110000) | (payload[17] & 0b00001111);

    @staticmethod
    def set_dribblerSeesBall(payload, dribblerSeesBall):
        payload[17] = ((dribblerSeesBall << 3) & 0b00001000) | (payload[17] & 0b11110111);

    @staticmethod
    def set_reserved1(payload, reserved1):
        payload[17] = (reserved1 & 0b00000111) | (payload[17] & 0b11111000);

    @staticmethod
    def set_wheelLocked(payload, wheelLocked):
        payload[18] = ((wheelLocked << 4) & 0b11110000) | (payload[18] & 0b00001111);

    @staticmethod
    def set_wheelBraking(payload, wheelBraking):
        payload[18] = (wheelBraking & 0b00001111) | (payload[18] & 0b11110000);
