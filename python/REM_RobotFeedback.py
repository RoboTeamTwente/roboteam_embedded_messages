...
class REM_RobotFeedback:
    ...
    batteryLevel = 0          # float   [0.000, 30.000]      The voltage level of the battery
...
# ================================ GETTERS ================================
    ...
    def get_batteryLevel(payload):
        _batteryLevel = ((payload[16]) << 8) | ((payload[17]));
        return (_batteryLevel * 0.0004577706569009);
    ...
    def get_ballPos(payload):
        _ballPos = ((payload[18] & 0b00001111));
    ...
    def get_reserved1(payload):
        return ((payload[19] & 0b01110000) >> 4);

    @staticmethod
    def get_wheelLocked(payload):
        return ((payload[19] & 0b00001111));

    @staticmethod
    def get_wheelBraking(payload):
        return ((payload[20] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_batteryLevel(payload, batteryLevel):
        _batteryLevel = int(batteryLevel / 0.0004577706569009);
        payload[16] = (_batteryLevel >> 8);
    ...
    def set_ballPos(payload, ballPos):
        ...
        payload[18] = (_ballPos & 0b00001111) | (payload[18] & 0b11110000);

    @staticmethod
    def set_dribblerSeesBall(payload, dribblerSeesBall):
        payload[19] = ((dribblerSeesBall << 7) & 0b10000000) | (payload[19] & 0b01111111);

    @staticmethod
    def set_reserved1(payload, reserved1):
        payload[19] = ((reserved1 << 4) & 0b01110000) | (payload[19] & 0b10001111);

    @staticmethod
    def set_wheelLocked(payload, wheelLocked):
        payload[19] = (wheelLocked & 0b00001111) | (payload[19] & 0b11110000);

    @staticmethod
    def set_wheelBraking(payload, wheelBraking):
        payload[20] = ((wheelBraking << 4) & 0b11110000) | (payload[20] & 0b00001111);

    @staticmethod
    def set_rssi(payload, rssi):
        payload[20] = ((rssi >> 4) & 0b00001111) | (payload[20] & 0b11110000);
        payload[21] = ((rssi << 4) & 0b11110000) | (payload[21] & 0b00001111);
