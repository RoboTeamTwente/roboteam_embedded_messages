...
class REM_RobotFeedback:
    ...
    filler = 0                # integer [0, 4194303]         filler bits to have equal or more bytes than REM_RobotCommand
...
# ================================ GETTERS ================================
    ...
    def get_filler(payload):
        return ((payload[21] & 0b00111111) << 16) | ((payload[22]) << 8) | ((payload[23]));
...
# ================================ SETTERS ================================
    ...
    def set_filler(payload, filler):
        payload[21] = ((filler >> 16) & 0b00111111) | (payload[21] & 0b11000000);
        payload[22] = (filler >> 8);
        payload[23] = filler;
