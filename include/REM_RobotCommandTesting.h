...
typedef struct _REM_RobotCommandTesting {
    ...
    float      yaw                 ; // float   [-3.142, 3.142]      Absolute angle (rad)
...
// ================================ GETTERS ================================
static inline uint32_t REM_RobotCommandTesting_get_packetType(REM_RobotCommandTestingPayload *remrctp){
...
static inline uint64_t REM_RobotCommandTesting_get_timestamp(REM_RobotCommandTestingPayload *remrctp){
    return ((uint64_t) (remrctp->payload[4]) << 40) | ((uint64_t) (remrctp->payload[5]) << 32) | ((uint32_t) (remrctp->payload[6]) << 24) | ((remrctp->payload[7]) << 16) | ((remrctp->payload[8]) << 8) | ((remrctp->payload[9]));
}

static inline uint32_t REM_RobotCommandTesting_get_payloadSize(REM_RobotCommandTestingPayload *remrctp){
    return ((remrctp->payload[10]));
}

static inline float REM_RobotCommandTesting_get_rho(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _rho = ((remrctp->payload[11]) << 8) | ((remrctp->payload[12]));
...
static inline float REM_RobotCommandTesting_get_theta(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _theta = ((remrctp->payload[13]) << 8) | ((remrctp->payload[14]));
    return (_theta * 0.0000958752621833F) + -3.1415926535897931F;
}

static inline float REM_RobotCommandTesting_get_yaw(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _yaw = ((remrctp->payload[15]) << 8) | ((remrctp->payload[16]));
...
static inline float REM_RobotCommandTesting_get_angularVelocity(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _angularVelocity = ((remrctp->payload[17]) << 8) | ((remrctp->payload[18]));
    return (_angularVelocity * 0.0009587526218325F) + -31.4159265358979312F;
}

static inline float REM_RobotCommandTesting_get_cameraYaw(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _cameraYaw = ((remrctp->payload[19]) << 8) | ((remrctp->payload[20]));
...
static inline float REM_RobotCommandTesting_get_wheelSpeedRef1(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelSpeedRef1 = ((remrctp->payload[21]) << 8) | ((remrctp->payload[22]));
...
static inline float REM_RobotCommandTesting_get_wheelSpeedRef2(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelSpeedRef2 = ((remrctp->payload[23]) << 8) | ((remrctp->payload[24]));
...
static inline float REM_RobotCommandTesting_get_wheelSpeedRef3(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelSpeedRef3 = ((remrctp->payload[25]) << 8) | ((remrctp->payload[26]));
...
static inline float REM_RobotCommandTesting_get_wheelSpeedRef4(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelSpeedRef4 = ((remrctp->payload[27]) << 8) | ((remrctp->payload[28]));
...
static inline float REM_RobotCommandTesting_get_wheelPWM1(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelPWM1 = ((remrctp->payload[29]) << 8) | ((remrctp->payload[30]));
...
static inline float REM_RobotCommandTesting_get_wheelPWM2(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelPWM2 = ((remrctp->payload[31]) << 8) | ((remrctp->payload[32]));
...
static inline float REM_RobotCommandTesting_get_wheelPWM3(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelPWM3 = ((remrctp->payload[33]) << 8) | ((remrctp->payload[34]));
...
static inline float REM_RobotCommandTesting_get_wheelPWM4(REM_RobotCommandTestingPayload *remrctp){
    uint32_t _wheelPWM4 = ((remrctp->payload[35]) << 8) | ((remrctp->payload[36]));
...
static inline bool REM_RobotCommandTesting_get_doForce(REM_RobotCommandTestingPayload *remrctp){
    return (remrctp->payload[37] & 0b00000100) > 0;
}

static inline bool REM_RobotCommandTesting_get_wheelsOff(REM_RobotCommandTestingPayload *remrctp){
    return (remrctp->payload[37] & 0b00000010) > 0;
}

static inline bool REM_RobotCommandTesting_get_feedback(REM_RobotCommandTestingPayload *remrctp){
    return (remrctp->payload[37] & 0b00000001) > 0;
}
...
static inline bool REM_RobotCommandTesting_get_reboot(REM_RobotCommandTestingPayload *remrctp){
    return (remrctp->payload[39] & 0b10000000) > 0;
}

static inline bool REM_RobotCommandTesting_get_useCameraYaw(REM_RobotCommandTestingPayload *remrctp){
    return (remrctp->payload[39] & 0b01000000) > 0;
}

static inline bool REM_RobotCommandTesting_get_useAbsoluteYaw(REM_RobotCommandTestingPayload *remrctp){
    return (remrctp->payload[39] & 0b00100000) > 0;
}
...
// ================================ SETTERS ================================
static inline void REM_RobotCommandTesting_set_packetType(REM_RobotCommandTestingPayload *remrctp, uint32_t packetType){
    remrctp->payload[0] = packetType;
}
...
static inline void REM_RobotCommandTesting_set_timestamp(REM_RobotCommandTestingPayload *remrctp, uint64_t timestamp){
    remrctp->payload[4] = (timestamp >> 40);
    remrctp->payload[5] = (timestamp >> 32);
    remrctp->payload[6] = (timestamp >> 24);
    remrctp->payload[7] = (timestamp >> 16);
    remrctp->payload[8] = (timestamp >> 8);
    remrctp->payload[9] = timestamp;
}

static inline void REM_RobotCommandTesting_set_payloadSize(REM_RobotCommandTestingPayload *remrctp, uint32_t payloadSize){
    remrctp->payload[10] = payloadSize;
}
...
static inline void REM_RobotCommandTesting_set_rho(REM_RobotCommandTestingPayload *remrctp, float rho){
    ...
    remrctp->payload[11] = (_rho >> 8);
    remrctp->payload[12] = _rho;
}
...
static inline void REM_RobotCommandTesting_set_theta(REM_RobotCommandTestingPayload *remrctp, float theta){
    ...
    remrctp->payload[13] = (_theta >> 8);
    remrctp->payload[14] = _theta;
}

static inline void REM_RobotCommandTesting_set_yaw(REM_RobotCommandTestingPayload *remrctp, float yaw){
    uint32_t _yaw = (uint32_t)((yaw +3.1415926535897931F) / 0.0000958752621833F);
    remrctp->payload[15] = (_yaw >> 8);
    remrctp->payload[16] = _yaw;
}
...
static inline void REM_RobotCommandTesting_set_angularVelocity(REM_RobotCommandTestingPayload *remrctp, float angularVelocity){
    ...
    remrctp->payload[17] = (_angularVelocity >> 8);
    remrctp->payload[18] = _angularVelocity;
}

static inline void REM_RobotCommandTesting_set_cameraYaw(REM_RobotCommandTestingPayload *remrctp, float cameraYaw){
    uint32_t _cameraYaw = (uint32_t)((cameraYaw +3.1415926535897931F) / 0.0000958752621833F);
    remrctp->payload[19] = (_cameraYaw >> 8);
    remrctp->payload[20] = _cameraYaw;
}
...
static inline void REM_RobotCommandTesting_set_wheelSpeedRef1(REM_RobotCommandTestingPayload *remrctp, float wheelSpeedRef1){
    ...
    remrctp->payload[21] = (_wheelSpeedRef1 >> 8);
    remrctp->payload[22] = _wheelSpeedRef1;
}
...
static inline void REM_RobotCommandTesting_set_wheelSpeedRef2(REM_RobotCommandTestingPayload *remrctp, float wheelSpeedRef2){
    ...
    remrctp->payload[23] = (_wheelSpeedRef2 >> 8);
    remrctp->payload[24] = _wheelSpeedRef2;
}
...
static inline void REM_RobotCommandTesting_set_wheelSpeedRef3(REM_RobotCommandTestingPayload *remrctp, float wheelSpeedRef3){
    ...
    remrctp->payload[25] = (_wheelSpeedRef3 >> 8);
    remrctp->payload[26] = _wheelSpeedRef3;
}
...
static inline void REM_RobotCommandTesting_set_wheelSpeedRef4(REM_RobotCommandTestingPayload *remrctp, float wheelSpeedRef4){
    ...
    remrctp->payload[27] = (_wheelSpeedRef4 >> 8);
    remrctp->payload[28] = _wheelSpeedRef4;
}
...
static inline void REM_RobotCommandTesting_set_wheelPWM1(REM_RobotCommandTestingPayload *remrctp, float wheelPWM1){
    ...
    remrctp->payload[29] = (_wheelPWM1 >> 8);
    remrctp->payload[30] = _wheelPWM1;
}
...
static inline void REM_RobotCommandTesting_set_wheelPWM2(REM_RobotCommandTestingPayload *remrctp, float wheelPWM2){
    ...
    remrctp->payload[31] = (_wheelPWM2 >> 8);
    remrctp->payload[32] = _wheelPWM2;
}
...
static inline void REM_RobotCommandTesting_set_wheelPWM3(REM_RobotCommandTestingPayload *remrctp, float wheelPWM3){
    ...
    remrctp->payload[33] = (_wheelPWM3 >> 8);
    remrctp->payload[34] = _wheelPWM3;
}
...
static inline void REM_RobotCommandTesting_set_wheelPWM4(REM_RobotCommandTestingPayload *remrctp, float wheelPWM4){
    ...
    remrctp->payload[35] = (_wheelPWM4 >> 8);
    remrctp->payload[36] = _wheelPWM4;
}
...
static inline void REM_RobotCommandTesting_set_useWheelSpeedRef(REM_RobotCommandTestingPayload *remrctp, bool useWheelSpeedRef){
    remrctp->payload[37] = ((useWheelSpeedRef << 7) & 0b10000000) | (remrctp->payload[37] & 0b01111111);
}

static inline void REM_RobotCommandTesting_set_useWheelPWMRef(REM_RobotCommandTestingPayload *remrctp, bool useWheelPWMRef){
    remrctp->payload[37] = ((useWheelPWMRef << 6) & 0b01000000) | (remrctp->payload[37] & 0b10111111);
}

static inline void REM_RobotCommandTesting_set_doKick(REM_RobotCommandTestingPayload *remrctp, bool doKick){
    remrctp->payload[37] = ((doKick << 5) & 0b00100000) | (remrctp->payload[37] & 0b11011111);
}

static inline void REM_RobotCommandTesting_set_doChip(REM_RobotCommandTestingPayload *remrctp, bool doChip){
    remrctp->payload[37] = ((doChip << 4) & 0b00010000) | (remrctp->payload[37] & 0b11101111);
}

static inline void REM_RobotCommandTesting_set_kickAtAngle(REM_RobotCommandTestingPayload *remrctp, bool kickAtAngle){
    remrctp->payload[37] = ((kickAtAngle << 3) & 0b00001000) | (remrctp->payload[37] & 0b11110111);
}

static inline void REM_RobotCommandTesting_set_doForce(REM_RobotCommandTestingPayload *remrctp, bool doForce){
    remrctp->payload[37] = ((doForce << 2) & 0b00000100) | (remrctp->payload[37] & 0b11111011);
}

static inline void REM_RobotCommandTesting_set_wheelsOff(REM_RobotCommandTestingPayload *remrctp, bool wheelsOff){
    remrctp->payload[37] = ((wheelsOff << 1) & 0b00000010) | (remrctp->payload[37] & 0b11111101);
}

static inline void REM_RobotCommandTesting_set_feedback(REM_RobotCommandTestingPayload *remrctp, bool feedback){
    remrctp->payload[37] = (feedback & 0b00000001) | (remrctp->payload[37] & 0b11111110);
}
...
static inline void REM_RobotCommandTesting_set_reboot(REM_RobotCommandTestingPayload *remrctp, bool reboot){
    remrctp->payload[39] = ((reboot << 7) & 0b10000000) | (remrctp->payload[39] & 0b01111111);
}

static inline void REM_RobotCommandTesting_set_useCameraYaw(REM_RobotCommandTestingPayload *remrctp, bool useCameraYaw){
    remrctp->payload[39] = ((useCameraYaw << 6) & 0b01000000) | (remrctp->payload[39] & 0b10111111);
}

static inline void REM_RobotCommandTesting_set_useAbsoluteYaw(REM_RobotCommandTestingPayload *remrctp, bool useAbsoluteYaw){
    remrctp->payload[39] = ((useAbsoluteYaw << 5) & 0b00100000) | (remrctp->payload[39] & 0b11011111);
}
...
static inline void encodeREM_RobotCommandTesting(REM_RobotCommandTestingPayload *remrctp, REM_RobotCommandTesting *remrct){
    REM_RobotCommandTesting_set_packetType          (remrctp, remrct->packetType);
    ...
    REM_RobotCommandTesting_set_yaw                 (remrctp, remrct->yaw);
    REM_RobotCommandTesting_set_angularVelocity     (remrctp, remrct->angularVelocity);
    REM_RobotCommandTesting_set_cameraYaw           (remrctp, remrct->cameraYaw);
    ...
    REM_RobotCommandTesting_set_wheelsOff           (remrctp, remrct->wheelsOff);
    ...
    REM_RobotCommandTesting_set_reboot              (remrctp, remrct->reboot);
...
static inline void decodeREM_RobotCommandTesting(REM_RobotCommandTesting *remrct, REM_RobotCommandTestingPayload *remrctp){
    remrct->packetType   = REM_RobotCommandTesting_get_packetType(remrctp);
    ...
    remrct->yaw          = REM_RobotCommandTesting_get_yaw(remrctp);
    remrct->angularVelocity= REM_RobotCommandTesting_get_angularVelocity(remrctp);
    remrct->cameraYaw    = REM_RobotCommandTesting_get_cameraYaw(remrctp);
    ...
    remrct->wheelsOff    = REM_RobotCommandTesting_get_wheelsOff(remrctp);
    ...
    remrct->reboot       = REM_RobotCommandTesting_get_reboot(remrctp);
