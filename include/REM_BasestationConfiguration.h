...
// ================================ GETTERS ================================
static inline uint32_t REM_BasestationConfiguration_get_packetType(REM_BasestationConfigurationPayload *rembcp){
...
static inline uint64_t REM_BasestationConfiguration_get_timestamp(REM_BasestationConfigurationPayload *rembcp){
    return ((uint64_t) (rembcp->payload[4]) << 40) | ((uint64_t) (rembcp->payload[5]) << 32) | ((uint32_t) (rembcp->payload[6]) << 24) | ((rembcp->payload[7]) << 16) | ((rembcp->payload[8]) << 8) | ((rembcp->payload[9]));
}

static inline uint32_t REM_BasestationConfiguration_get_payloadSize(REM_BasestationConfigurationPayload *rembcp){
    return ((rembcp->payload[10]));
}

static inline bool REM_BasestationConfiguration_get_channel(REM_BasestationConfigurationPayload *rembcp){
    return (rembcp->payload[11] & 0b10000000) > 0;
}

// ================================ SETTERS ================================
static inline void REM_BasestationConfiguration_set_packetType(REM_BasestationConfigurationPayload *rembcp, uint32_t packetType){
    rembcp->payload[0] = packetType;
}
...
static inline void REM_BasestationConfiguration_set_timestamp(REM_BasestationConfigurationPayload *rembcp, uint64_t timestamp){
    rembcp->payload[4] = (timestamp >> 40);
    rembcp->payload[5] = (timestamp >> 32);
    rembcp->payload[6] = (timestamp >> 24);
    rembcp->payload[7] = (timestamp >> 16);
    rembcp->payload[8] = (timestamp >> 8);
    rembcp->payload[9] = timestamp;
}
...
static inline void encodeREM_BasestationConfiguration(REM_BasestationConfigurationPayload *rembcp, REM_BasestationConfiguration *rembc){
    REM_BasestationConfiguration_set_packetType          (rembcp, rembc->packetType);
...
static inline void decodeREM_BasestationConfiguration(REM_BasestationConfiguration *rembc, REM_BasestationConfigurationPayload *rembcp){
    rembc->packetType    = REM_BasestationConfiguration_get_packetType(rembcp);
