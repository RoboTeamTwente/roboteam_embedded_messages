...
static inline bool REM_RobotStateInfo_get_needTimeStamp(REM_RobotStateInfoPayload *remrsip){
...
static inline void REM_RobotStateInfo_set_fromBS(REM_RobotStateInfoPayload *remrsip, bool fromBS){
    remrsip->payload[2] = ((fromBS << 2) & 0b00000100) | (remrsip->payload[2] & 0b11111011);
}

static inline void REM_RobotStateInfo_set_fromPC(REM_RobotStateInfoPayload *remrsip, bool fromPC){
    remrsip->payload[2] = ((fromPC << 1) & 0b00000010) | (remrsip->payload[2] & 0b11111101);
}

static inline void REM_RobotStateInfo_set_needTimeStamp(REM_RobotStateInfoPayload *remrsip, bool needTimeStamp){
    remrsip->payload[2] = (needTimeStamp & 0b00000001) | (remrsip->payload[2] & 0b11111110);
}
...
static inline void encodeREM_RobotStateInfo(REM_RobotStateInfoPayload *remrsip, REM_RobotStateInfo *remrsi){
    ...
    REM_RobotStateInfo_set_needTimeStamp       (remrsip, remrsi->needTimeStamp);
...
static inline void decodeREM_RobotStateInfo(REM_RobotStateInfo *remrsi, REM_RobotStateInfoPayload *remrsip){
    ...
    remrsi->needTimeStamp= REM_RobotStateInfo_get_needTimeStamp(remrsip);
