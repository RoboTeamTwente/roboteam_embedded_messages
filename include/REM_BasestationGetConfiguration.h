...
// ================================ GETTERS ================================
static inline uint32_t REM_BasestationGetConfiguration_get_packetType(REM_BasestationGetConfigurationPayload *rembgcp){
...
static inline uint64_t REM_BasestationGetConfiguration_get_timestamp(REM_BasestationGetConfigurationPayload *rembgcp){
    return ((uint64_t) (rembgcp->payload[4]) << 40) | ((uint64_t) (rembgcp->payload[5]) << 32) | ((uint32_t) (rembgcp->payload[6]) << 24) | ((rembgcp->payload[7]) << 16) | ((rembgcp->payload[8]) << 8) | ((rembgcp->payload[9]));
}

static inline uint32_t REM_BasestationGetConfiguration_get_payloadSize(REM_BasestationGetConfigurationPayload *rembgcp){
    return ((rembgcp->payload[10]));
}

// ================================ SETTERS ================================
static inline void REM_BasestationGetConfiguration_set_packetType(REM_BasestationGetConfigurationPayload *rembgcp, uint32_t packetType){
    rembgcp->payload[0] = packetType;
}
...
static inline void REM_BasestationGetConfiguration_set_timestamp(REM_BasestationGetConfigurationPayload *rembgcp, uint64_t timestamp){
    rembgcp->payload[4] = (timestamp >> 40);
    rembgcp->payload[5] = (timestamp >> 32);
    rembgcp->payload[6] = (timestamp >> 24);
    rembgcp->payload[7] = (timestamp >> 16);
    rembgcp->payload[8] = (timestamp >> 8);
    rembgcp->payload[9] = timestamp;
}
...
static inline void REM_BasestationGetConfiguration_set_payloadSize(REM_BasestationGetConfigurationPayload *rembgcp, uint32_t payloadSize){
    rembgcp->payload[10] = payloadSize;
}
...
static inline void encodeREM_BasestationGetConfiguration(REM_BasestationGetConfigurationPayload *rembgcp, REM_BasestationGetConfiguration *rembgc){
    REM_BasestationGetConfiguration_set_packetType          (rembgcp, rembgc->packetType);
...
static inline void decodeREM_BasestationGetConfiguration(REM_BasestationGetConfiguration *rembgc, REM_BasestationGetConfigurationPayload *rembgcp){
    rembgc->packetType   = REM_BasestationGetConfiguration_get_packetType(rembgcp);
