...
static inline float REM_RobotPIDGains_get_IbodyYaw(REM_RobotPIDGainsPayload *remrpidgp){
    uint32_t _IbodyYaw = ((remrpidgp->payload[36]) << 8) | ((remrpidgp->payload[37]));
...
static inline float REM_RobotPIDGains_get_DbodyYaw(REM_RobotPIDGainsPayload *remrpidgp){
    uint32_t _DbodyYaw = ((remrpidgp->payload[38]) << 8) | ((remrpidgp->payload[39]));
...
static inline float REM_RobotPIDGains_get_DbodyYaw2(REM_RobotPIDGainsPayload *remrpidgp){
    uint32_t _DbodyYaw2 = ((remrpidgp->payload[40]) << 8) | ((remrpidgp->payload[41]));
...
static inline void REM_RobotPIDGains_set_timestamp(REM_RobotPIDGainsPayload *remrpidgp, uint64_t timestamp){
    remrpidgp->payload[4] = (timestamp >> 32);
    remrpidgp->payload[5] = (timestamp >> 24);
    remrpidgp->payload[6] = (timestamp >> 16);
    remrpidgp->payload[7] = (timestamp >> 8);
    remrpidgp->payload[8] = timestamp;
}

static inline void REM_RobotPIDGains_set_payloadSize(REM_RobotPIDGainsPayload *remrpidgp, uint32_t payloadSize){
    remrpidgp->payload[9] = payloadSize;
}
...
static inline void REM_RobotPIDGains_set_PbodyX(REM_RobotPIDGainsPayload *remrpidgp, float PbodyX){
    ...
    remrpidgp->payload[10] = (_PbodyX >> 8);
    remrpidgp->payload[11] = _PbodyX;
}
...
static inline void REM_RobotPIDGains_set_IbodyX(REM_RobotPIDGainsPayload *remrpidgp, float IbodyX){
    ...
    remrpidgp->payload[12] = (_IbodyX >> 8);
    remrpidgp->payload[13] = _IbodyX;
}
...
static inline void REM_RobotPIDGains_set_DbodyX(REM_RobotPIDGainsPayload *remrpidgp, float DbodyX){
    ...
    remrpidgp->payload[14] = (_DbodyX >> 8);
    remrpidgp->payload[15] = _DbodyX;
}
...
static inline void REM_RobotPIDGains_set_DbodyX2(REM_RobotPIDGainsPayload *remrpidgp, float DbodyX2){
    ...
    remrpidgp->payload[16] = (_DbodyX2 >> 8);
    remrpidgp->payload[17] = _DbodyX2;
}
...
static inline void REM_RobotPIDGains_set_PbodyY(REM_RobotPIDGainsPayload *remrpidgp, float PbodyY){
    ...
    remrpidgp->payload[18] = (_PbodyY >> 8);
    remrpidgp->payload[19] = _PbodyY;
}
...
static inline void REM_RobotPIDGains_set_IbodyY(REM_RobotPIDGainsPayload *remrpidgp, float IbodyY){
    ...
    remrpidgp->payload[20] = (_IbodyY >> 8);
    remrpidgp->payload[21] = _IbodyY;
}
...
static inline void REM_RobotPIDGains_set_DbodyY(REM_RobotPIDGainsPayload *remrpidgp, float DbodyY){
    ...
    remrpidgp->payload[22] = (_DbodyY >> 8);
    remrpidgp->payload[23] = _DbodyY;
}
...
static inline void REM_RobotPIDGains_set_DbodyY2(REM_RobotPIDGainsPayload *remrpidgp, float DbodyY2){
    ...
    remrpidgp->payload[24] = (_DbodyY2 >> 8);
    remrpidgp->payload[25] = _DbodyY2;
}
...
static inline void REM_RobotPIDGains_set_PbodyW(REM_RobotPIDGainsPayload *remrpidgp, float PbodyW){
    ...
    remrpidgp->payload[26] = (_PbodyW >> 8);
    remrpidgp->payload[27] = _PbodyW;
}
...
static inline void REM_RobotPIDGains_set_IbodyW(REM_RobotPIDGainsPayload *remrpidgp, float IbodyW){
    ...
    remrpidgp->payload[28] = (_IbodyW >> 8);
    remrpidgp->payload[29] = _IbodyW;
}
...
static inline void REM_RobotPIDGains_set_DbodyW(REM_RobotPIDGainsPayload *remrpidgp, float DbodyW){
    ...
    remrpidgp->payload[30] = (_DbodyW >> 8);
    remrpidgp->payload[31] = _DbodyW;
}
...
static inline void REM_RobotPIDGains_set_DbodyW2(REM_RobotPIDGainsPayload *remrpidgp, float DbodyW2){
    ...
    remrpidgp->payload[32] = (_DbodyW2 >> 8);
    remrpidgp->payload[33] = _DbodyW2;
}
...
static inline void REM_RobotPIDGains_set_PbodyYaw(REM_RobotPIDGainsPayload *remrpidgp, float PbodyYaw){
    ...
    remrpidgp->payload[34] = (_PbodyYaw >> 8);
    remrpidgp->payload[35] = _PbodyYaw;
}
...
static inline void REM_RobotPIDGains_set_IbodyYaw(REM_RobotPIDGainsPayload *remrpidgp, float IbodyYaw){
    ...
    remrpidgp->payload[36] = (_IbodyYaw >> 8);
    remrpidgp->payload[37] = _IbodyYaw;
}
...
static inline void REM_RobotPIDGains_set_DbodyYaw(REM_RobotPIDGainsPayload *remrpidgp, float DbodyYaw){
    ...
    remrpidgp->payload[38] = (_DbodyYaw >> 8);
    remrpidgp->payload[39] = _DbodyYaw;
}
...
static inline void REM_RobotPIDGains_set_DbodyYaw2(REM_RobotPIDGainsPayload *remrpidgp, float DbodyYaw2){
    ...
    remrpidgp->payload[40] = (_DbodyYaw2 >> 8);
    remrpidgp->payload[41] = _DbodyYaw2;
}
...
static inline void REM_RobotPIDGains_set_Pwheels(REM_RobotPIDGainsPayload *remrpidgp, float Pwheels){
    ...
    remrpidgp->payload[42] = (_Pwheels >> 8);
    remrpidgp->payload[43] = _Pwheels;
}
...
static inline void REM_RobotPIDGains_set_Iwheels(REM_RobotPIDGainsPayload *remrpidgp, float Iwheels){
    ...
    remrpidgp->payload[44] = (_Iwheels >> 8);
    remrpidgp->payload[45] = _Iwheels;
}
...
static inline void REM_RobotPIDGains_set_Dwheels(REM_RobotPIDGainsPayload *remrpidgp, float Dwheels){
    ...
    remrpidgp->payload[46] = (_Dwheels >> 8);
    remrpidgp->payload[47] = _Dwheels;
}
