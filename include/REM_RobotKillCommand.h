...
// ================================ GETTERS ================================
static inline uint32_t REM_RobotKillCommand_get_packetType(REM_RobotKillCommandPayload *remrkcp){
...
static inline uint64_t REM_RobotKillCommand_get_timestamp(REM_RobotKillCommandPayload *remrkcp){
    return ((uint64_t) (remrkcp->payload[4]) << 40) | ((uint64_t) (remrkcp->payload[5]) << 32) | ((uint32_t) (remrkcp->payload[6]) << 24) | ((remrkcp->payload[7]) << 16) | ((remrkcp->payload[8]) << 8) | ((remrkcp->payload[9]));
}

static inline uint32_t REM_RobotKillCommand_get_payloadSize(REM_RobotKillCommandPayload *remrkcp){
    return ((remrkcp->payload[10]));
}

// ================================ SETTERS ================================
static inline void REM_RobotKillCommand_set_packetType(REM_RobotKillCommandPayload *remrkcp, uint32_t packetType){
    remrkcp->payload[0] = packetType;
}
...
static inline void REM_RobotKillCommand_set_timestamp(REM_RobotKillCommandPayload *remrkcp, uint64_t timestamp){
    remrkcp->payload[4] = (timestamp >> 40);
    remrkcp->payload[5] = (timestamp >> 32);
    remrkcp->payload[6] = (timestamp >> 24);
    remrkcp->payload[7] = (timestamp >> 16);
    remrkcp->payload[8] = (timestamp >> 8);
    remrkcp->payload[9] = timestamp;
}

static inline void REM_RobotKillCommand_set_payloadSize(REM_RobotKillCommandPayload *remrkcp, uint32_t payloadSize){
    remrkcp->payload[10] = payloadSize;
}

// ================================ ENCODE ================================
static inline void encodeREM_RobotKillCommand(REM_RobotKillCommandPayload *remrkcp, REM_RobotKillCommand *remrkc){
    REM_RobotKillCommand_set_packetType          (remrkcp, remrkc->packetType);
...
static inline void decodeREM_RobotKillCommand(REM_RobotKillCommand *remrkc, REM_RobotKillCommandPayload *remrkcp){
    remrkc->packetType   = REM_RobotKillCommand_get_packetType(remrkcp);
