...
// ================================ GETTERS ================================
static inline uint32_t RobotFeedback_get_header(RobotFeedbackPayload *rfp) { return ((rfp->payload[0])); }

static inline uint32_t RobotFeedback_get_remVersion(RobotFeedbackPayload *rfp) { return ((rfp->payload[1] & 0b11110000) >> 4); }

static inline uint32_t RobotFeedback_get_id(RobotFeedbackPayload *rfp) { return ((rfp->payload[1] & 0b00001111)); }

static inline uint32_t RobotFeedback_get_messageId(RobotFeedbackPayload *rfp) { return ((rfp->payload[2] & 0b11110000) >> 4); }

static inline uint32_t RobotFeedback_get_batteryLevel(RobotFeedbackPayload *rfp) { return ((rfp->payload[2] & 0b00001111)); }

static inline bool RobotFeedback_get_XsensCalibrated(RobotFeedbackPayload *rfp) { return (rfp->payload[3] & 0b10000000) > 0; }

static inline bool RobotFeedback_get_ballSensorWorking(RobotFeedbackPayload *rfp) { return (rfp->payload[3] & 0b01000000) > 0; }

static inline bool RobotFeedback_get_hasBall(RobotFeedbackPayload *rfp) { return (rfp->payload[3] & 0b00100000) > 0; }

static inline bool RobotFeedback_get_capacitorCharged(RobotFeedbackPayload *rfp) { return (rfp->payload[3] & 0b00010000) > 0; }
...
static inline uint32_t RobotFeedback_get_wheelLocked(RobotFeedbackPayload *rfp) { return ((rfp->payload[10] & 0b11110000) >> 4); }

static inline uint32_t RobotFeedback_get_wheelBraking(RobotFeedbackPayload *rfp) { return ((rfp->payload[10] & 0b00001111)); }

static inline uint32_t RobotFeedback_get_rssi(RobotFeedbackPayload *rfp) { return ((rfp->payload[11] & 0b11110000) >> 4); }

// ================================ SETTERS ================================
static inline void RobotFeedback_set_header(RobotFeedbackPayload *rfp, uint32_t header) { rfp->payload[0] = header; }
...
static inline void RobotFeedback_set_id(RobotFeedbackPayload *rfp, uint32_t id) { rfp->payload[1] = (id & 0b00001111) | (rfp->payload[1] & 0b11110000); }
...
static inline void RobotFeedback_set_hasBall(RobotFeedbackPayload *rfp, bool hasBall) { rfp->payload[3] = ((hasBall << 5) & 0b00100000) | (rfp->payload[3] & 0b11011111); }
...
static inline void RobotFeedback_set_rssi(RobotFeedbackPayload *rfp, uint32_t rssi) { rfp->payload[11] = ((rssi << 4) & 0b11110000) | (rfp->payload[11] & 0b00001111); }
