...
static inline float REM_RobotCommand_get_cameraYaw(REM_RobotCommandPayload *remrcp){
    uint32_t _cameraYaw = ((remrcp->payload[17]) << 8) | ((remrcp->payload[18]));
...
static inline float REM_RobotCommand_get_kickChipPower(REM_RobotCommandPayload *remrcp){
    uint32_t _kickChipPower = ((remrcp->payload[19]));
...
static inline bool REM_RobotCommand_get_sendStateInfo(REM_RobotCommandPayload *remrcp){
    return (remrcp->payload[21] & 0b00000100) > 0;
}
...
static inline void REM_RobotCommand_set_cameraYaw(REM_RobotCommandPayload *remrcp, float cameraYaw){
    ...
    remrcp->payload[17] = (_cameraYaw >> 8);
    remrcp->payload[18] = _cameraYaw;
}
