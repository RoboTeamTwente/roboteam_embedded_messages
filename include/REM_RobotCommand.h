...
-------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- 11111111 11111111 -------- -------- -------- -------- -------- acceleration_magnitude
-------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- 11111111 11111111 -------- -------- -------- acceleration_angle
...
typedef struct _REM_RobotCommand {
    ...
    float      acceleration_magnitude; // float   [-15.000, 15.000]    Magnitude of acceleration (m/s^2)
    float      acceleration_angle  ; // float   [-3.142, 3.142]      Angle of acceleration (rad)
...
static inline void REM_RobotCommand_set_acceleration_magnitude(REM_RobotCommandPayload *remrcp, float acceleration_magnitude){
    uint32_t _acceleration_magnitude = (uint32_t)((acceleration_magnitude +15.0000000000000000F) / 0.0004577706569009F);
    remrcp->payload[21] = (_acceleration_magnitude >> 8);
    remrcp->payload[22] = _acceleration_magnitude;
}

static inline void REM_RobotCommand_set_acceleration_angle(REM_RobotCommandPayload *remrcp, float acceleration_angle){
    uint32_t _acceleration_angle = (uint32_t)((acceleration_angle +3.1415926535897931F) / 0.0000958752621833F);
    remrcp->payload[23] = (_acceleration_angle >> 8);
    remrcp->payload[24] = _acceleration_angle;
}
...
static inline void encodeREM_RobotCommand(REM_RobotCommandPayload *remrcp, REM_RobotCommand *remrc){
    ...
    REM_RobotCommand_set_acceleration_magnitude(remrcp, remrc->acceleration_magnitude);
    REM_RobotCommand_set_acceleration_angle  (remrcp, remrc->acceleration_angle);
...
static inline void decodeREM_RobotCommand(REM_RobotCommand *remrc, REM_RobotCommandPayload *remrcp){
    ...
    remrc->acceleration_magnitude= REM_RobotCommand_get_acceleration_magnitude(remrcp);
    remrc->acceleration_angle= REM_RobotCommand_get_acceleration_angle(remrcp);
