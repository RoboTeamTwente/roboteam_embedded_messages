...
// ================================ GETTERS ================================
static inline uint32_t REM_RobotAssuredAck_get_packetType(REM_RobotAssuredAckPayload *remraap){
...
static inline uint64_t REM_RobotAssuredAck_get_timestamp(REM_RobotAssuredAckPayload *remraap){
    return ((uint64_t) (remraap->payload[4]) << 40) | ((uint64_t) (remraap->payload[5]) << 32) | ((uint32_t) (remraap->payload[6]) << 24) | ((remraap->payload[7]) << 16) | ((remraap->payload[8]) << 8) | ((remraap->payload[9]));
}

static inline uint32_t REM_RobotAssuredAck_get_payloadSize(REM_RobotAssuredAckPayload *remraap){
    return ((remraap->payload[10]));
}

static inline uint32_t REM_RobotAssuredAck_get_sequenceNumber(REM_RobotAssuredAckPayload *remraap){
    return ((remraap->payload[11]));
}

// ================================ SETTERS ================================
static inline void REM_RobotAssuredAck_set_packetType(REM_RobotAssuredAckPayload *remraap, uint32_t packetType){
    remraap->payload[0] = packetType;
}
...
static inline void REM_RobotAssuredAck_set_timestamp(REM_RobotAssuredAckPayload *remraap, uint64_t timestamp){
    remraap->payload[4] = (timestamp >> 40);
    remraap->payload[5] = (timestamp >> 32);
    remraap->payload[6] = (timestamp >> 24);
    remraap->payload[7] = (timestamp >> 16);
    remraap->payload[8] = (timestamp >> 8);
    remraap->payload[9] = timestamp;
}

static inline void REM_RobotAssuredAck_set_payloadSize(REM_RobotAssuredAckPayload *remraap, uint32_t payloadSize){
    remraap->payload[10] = payloadSize;
}

static inline void REM_RobotAssuredAck_set_sequenceNumber(REM_RobotAssuredAckPayload *remraap, uint32_t sequenceNumber){
    remraap->payload[11] = sequenceNumber;
}

// ================================ ENCODE ================================
static inline void encodeREM_RobotAssuredAck(REM_RobotAssuredAckPayload *remraap, REM_RobotAssuredAck *remraa){
    REM_RobotAssuredAck_set_packetType          (remraap, remraa->packetType);
...
static inline void decodeREM_RobotAssuredAck(REM_RobotAssuredAck *remraa, REM_RobotAssuredAckPayload *remraap){
    remraa->packetType   = REM_RobotAssuredAck_get_packetType(remraap);
