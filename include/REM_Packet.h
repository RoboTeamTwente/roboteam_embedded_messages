...
// ================================ GETTERS ================================
static inline uint32_t REM_Packet_get_packetType(REM_PacketPayload *rempp){
...
static inline uint64_t REM_Packet_get_timestamp(REM_PacketPayload *rempp){
    return ((uint64_t) (rempp->payload[4]) << 40) | ((uint64_t) (rempp->payload[5]) << 32) | ((uint32_t) (rempp->payload[6]) << 24) | ((rempp->payload[7]) << 16) | ((rempp->payload[8]) << 8) | ((rempp->payload[9]));
}

static inline uint32_t REM_Packet_get_payloadSize(REM_PacketPayload *rempp){
    return ((rempp->payload[10]));
}

// ================================ SETTERS ================================
static inline void REM_Packet_set_packetType(REM_PacketPayload *rempp, uint32_t packetType){
    rempp->payload[0] = packetType;
}
...
static inline void REM_Packet_set_timestamp(REM_PacketPayload *rempp, uint64_t timestamp){
    rempp->payload[4] = (timestamp >> 40);
    rempp->payload[5] = (timestamp >> 32);
    rempp->payload[6] = (timestamp >> 24);
    rempp->payload[7] = (timestamp >> 16);
    rempp->payload[8] = (timestamp >> 8);
    rempp->payload[9] = timestamp;
}

static inline void REM_Packet_set_payloadSize(REM_PacketPayload *rempp, uint32_t payloadSize){
    rempp->payload[10] = payloadSize;
}

// ================================ ENCODE ================================
static inline void encodeREM_Packet(REM_PacketPayload *rempp, REM_Packet *remp){
    REM_Packet_set_packetType          (rempp, remp->packetType);
...
static inline void decodeREM_Packet(REM_Packet *remp, REM_PacketPayload *rempp){
    remp->packetType     = REM_Packet_get_packetType(rempp);
