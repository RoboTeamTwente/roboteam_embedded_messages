...
-------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- ----1111 1111---- -------- -------- -------- bodyXIntegral
-------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- ----1111 1111---- -------- -------- bodyYIntegral
-------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- ----1111 1111---- -------- bodyWIntegral
-------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- ----1111 1111---- bodyYawIntegral
*/
...
typedef struct _RobotStateInfo {
    ...
    uint32_t   bodyXIntegral       ; // integer [0, 255]             Integral value from the PID for body_x
    uint32_t   bodyYIntegral       ; // integer [0, 255]             Integral value from the PID for body_y
    uint32_t   bodyWIntegral       ; // integer [0, 255]             Integral value from the PID for body_w
    uint32_t   bodyYawIntegral     ; // integer [0, 255]             Integral value from the PID for body_Yaw
} RobotStateInfo;
...
static inline uint32_t RobotStateInfo_get_bodyXIntegral(RobotStateInfoPayload *rsip){
    return ((rsip->payload[34] & 0b00001111) << 4) | ((rsip->payload[35] & 0b11110000) >> 4);
}

static inline uint32_t RobotStateInfo_get_bodyYIntegral(RobotStateInfoPayload *rsip){
    return ((rsip->payload[35] & 0b00001111) << 4) | ((rsip->payload[36] & 0b11110000) >> 4);
}

static inline uint32_t RobotStateInfo_get_bodyWIntegral(RobotStateInfoPayload *rsip){
    return ((rsip->payload[36] & 0b00001111) << 4) | ((rsip->payload[37] & 0b11110000) >> 4);
}

static inline uint32_t RobotStateInfo_get_bodyYawIntegral(RobotStateInfoPayload *rsip){
    return ((rsip->payload[37] & 0b00001111) << 4) | ((rsip->payload[38] & 0b11110000) >> 4);
}
...
static inline void RobotStateInfo_set_bodyXIntegral(RobotStateInfoPayload *rsip, uint32_t bodyXIntegral){
    rsip->payload[34] = ((bodyXIntegral >> 4) & 0b00001111) | (rsip->payload[34] & 0b11110000);
    rsip->payload[35] = ((bodyXIntegral << 4) & 0b11110000) | (rsip->payload[35] & 0b00001111);
}

static inline void RobotStateInfo_set_bodyYIntegral(RobotStateInfoPayload *rsip, uint32_t bodyYIntegral){
    rsip->payload[35] = ((bodyYIntegral >> 4) & 0b00001111) | (rsip->payload[35] & 0b11110000);
    rsip->payload[36] = ((bodyYIntegral << 4) & 0b11110000) | (rsip->payload[36] & 0b00001111);
}

static inline void RobotStateInfo_set_bodyWIntegral(RobotStateInfoPayload *rsip, uint32_t bodyWIntegral){
    rsip->payload[36] = ((bodyWIntegral >> 4) & 0b00001111) | (rsip->payload[36] & 0b11110000);
    rsip->payload[37] = ((bodyWIntegral << 4) & 0b11110000) | (rsip->payload[37] & 0b00001111);
}

static inline void RobotStateInfo_set_bodyYawIntegral(RobotStateInfoPayload *rsip, uint32_t bodyYawIntegral){
    rsip->payload[37] = ((bodyYawIntegral >> 4) & 0b00001111) | (rsip->payload[37] & 0b11110000);
    rsip->payload[38] = ((bodyYawIntegral << 4) & 0b11110000) | (rsip->payload[38] & 0b00001111);
}
