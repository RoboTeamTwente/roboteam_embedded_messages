...
static inline float RobotStateInfo_get_wheel1Integral(RobotStateInfoPayload *rsip){
    uint32_t _wheel1Integral = ((rsip->payload[50] & 0b00001111) << 28) | ((rsip->payload[51]) << 20) | ((rsip->payload[52]) << 12) | ((rsip->payload[53]) << 4) | ((rsip->payload[54] & 0b11110000) >> 4);
    return (_wheel1Integral * 0.0000232830643708) + -50000.0000000000000000;
}

static inline float RobotStateInfo_get_wheel2Integral(RobotStateInfoPayload *rsip){
    uint32_t _wheel2Integral = ((rsip->payload[54] & 0b00001111) << 28) | ((rsip->payload[55]) << 20) | ((rsip->payload[56]) << 12) | ((rsip->payload[57]) << 4) | ((rsip->payload[58] & 0b11110000) >> 4);
    return (_wheel2Integral * 0.0000232830643708) + -50000.0000000000000000;
}

static inline float RobotStateInfo_get_wheel3Integral(RobotStateInfoPayload *rsip){
    uint32_t _wheel3Integral = ((rsip->payload[58] & 0b00001111) << 28) | ((rsip->payload[59]) << 20) | ((rsip->payload[60]) << 12) | ((rsip->payload[61]) << 4) | ((rsip->payload[62] & 0b11110000) >> 4);
    return (_wheel3Integral * 0.0000232830643708) + -50000.0000000000000000;
}

static inline float RobotStateInfo_get_wheel4Integral(RobotStateInfoPayload *rsip){
    uint32_t _wheel4Integral = ((rsip->payload[62] & 0b00001111) << 28) | ((rsip->payload[63]) << 20) | ((rsip->payload[64]) << 12) | ((rsip->payload[65]) << 4) | ((rsip->payload[66] & 0b11110000) >> 4);
...
static inline void RobotStateInfo_set_bodyXIntegral(RobotStateInfoPayload *rsip, float bodyXIntegral){
    ...
    rsip->payload[37] = (_bodyXIntegral >> 4);
    rsip->payload[38] = ((_bodyXIntegral << 4) & 0b11110000) | (rsip->payload[38] & 0b00001111);
}
...
static inline void RobotStateInfo_set_bodyYIntegral(RobotStateInfoPayload *rsip, float bodyYIntegral){
    ...
    rsip->payload[41] = (_bodyYIntegral >> 4);
    rsip->payload[42] = ((_bodyYIntegral << 4) & 0b11110000) | (rsip->payload[42] & 0b00001111);
}
...
static inline void RobotStateInfo_set_bodyWIntegral(RobotStateInfoPayload *rsip, float bodyWIntegral){
    ...
    rsip->payload[45] = (_bodyWIntegral >> 4);
    rsip->payload[46] = ((_bodyWIntegral << 4) & 0b11110000) | (rsip->payload[46] & 0b00001111);
}
...
static inline void RobotStateInfo_set_bodyYawIntegral(RobotStateInfoPayload *rsip, float bodyYawIntegral){
    ...
    rsip->payload[49] = (_bodyYawIntegral >> 4);
    rsip->payload[50] = ((_bodyYawIntegral << 4) & 0b11110000) | (rsip->payload[50] & 0b00001111);
}

static inline void RobotStateInfo_set_wheel1Integral(RobotStateInfoPayload *rsip, float wheel1Integral){
    uint32_t _wheel1Integral = (uint32_t)((wheel1Integral +50000.0000000000000000) / 0.0000232830643708);
    rsip->payload[50] = ((_wheel1Integral >> 28) & 0b00001111) | (rsip->payload[50] & 0b11110000);
    rsip->payload[51] = (_wheel1Integral >> 20);
    rsip->payload[52] = (_wheel1Integral >> 12);
    rsip->payload[53] = (_wheel1Integral >> 4);
    rsip->payload[54] = ((_wheel1Integral << 4) & 0b11110000) | (rsip->payload[54] & 0b00001111);
}

static inline void RobotStateInfo_set_wheel2Integral(RobotStateInfoPayload *rsip, float wheel2Integral){
    uint32_t _wheel2Integral = (uint32_t)((wheel2Integral +50000.0000000000000000) / 0.0000232830643708);
    rsip->payload[54] = ((_wheel2Integral >> 28) & 0b00001111) | (rsip->payload[54] & 0b11110000);
    rsip->payload[55] = (_wheel2Integral >> 20);
    rsip->payload[56] = (_wheel2Integral >> 12);
    rsip->payload[57] = (_wheel2Integral >> 4);
    rsip->payload[58] = ((_wheel2Integral << 4) & 0b11110000) | (rsip->payload[58] & 0b00001111);
}

static inline void RobotStateInfo_set_wheel3Integral(RobotStateInfoPayload *rsip, float wheel3Integral){
    uint32_t _wheel3Integral = (uint32_t)((wheel3Integral +50000.0000000000000000) / 0.0000232830643708);
    rsip->payload[58] = ((_wheel3Integral >> 28) & 0b00001111) | (rsip->payload[58] & 0b11110000);
    rsip->payload[59] = (_wheel3Integral >> 20);
    rsip->payload[60] = (_wheel3Integral >> 12);
    rsip->payload[61] = (_wheel3Integral >> 4);
    rsip->payload[62] = ((_wheel3Integral << 4) & 0b11110000) | (rsip->payload[62] & 0b00001111);
}

static inline void RobotStateInfo_set_wheel4Integral(RobotStateInfoPayload *rsip, float wheel4Integral){
    uint32_t _wheel4Integral = (uint32_t)((wheel4Integral +50000.0000000000000000) / 0.0000232830643708);
    rsip->payload[62] = ((_wheel4Integral >> 28) & 0b00001111) | (rsip->payload[62] & 0b11110000);
    rsip->payload[63] = (_wheel4Integral >> 20);
    rsip->payload[64] = (_wheel4Integral >> 12);
    rsip->payload[65] = (_wheel4Integral >> 4);
    rsip->payload[66] = ((_wheel4Integral << 4) & 0b11110000) | (rsip->payload[66] & 0b00001111);
}
...
static inline void encodeRobotStateInfo(RobotStateInfoPayload *rsip, RobotStateInfo *rsi){
    ...
    RobotStateInfo_set_bodyXIntegral       (rsip, rsi->bodyXIntegral);
    RobotStateInfo_set_bodyYIntegral       (rsip, rsi->bodyYIntegral);
    RobotStateInfo_set_bodyWIntegral       (rsip, rsi->bodyWIntegral);
    RobotStateInfo_set_bodyYawIntegral     (rsip, rsi->bodyYawIntegral);
    RobotStateInfo_set_wheel1Integral      (rsip, rsi->wheel1Integral);
    RobotStateInfo_set_wheel2Integral      (rsip, rsi->wheel2Integral);
    RobotStateInfo_set_wheel3Integral      (rsip, rsi->wheel3Integral);
    RobotStateInfo_set_wheel4Integral      (rsip, rsi->wheel4Integral);
}
...
static inline void decodeRobotStateInfo(RobotStateInfo *rsi, RobotStateInfoPayload *rsip){
    ...
    rsi->bodyXIntegral   = RobotStateInfo_get_bodyXIntegral(rsip);
    rsi->bodyYIntegral   = RobotStateInfo_get_bodyYIntegral(rsip);
    rsi->bodyWIntegral   = RobotStateInfo_get_bodyWIntegral(rsip);
    rsi->bodyYawIntegral = RobotStateInfo_get_bodyYawIntegral(rsip);
    rsi->wheel1Integral  = RobotStateInfo_get_wheel1Integral(rsip);
    rsi->wheel2Integral  = RobotStateInfo_get_wheel2Integral(rsip);
    rsi->wheel3Integral  = RobotStateInfo_get_wheel3Integral(rsip);
    rsi->wheel4Integral  = RobotStateInfo_get_wheel4Integral(rsip);
}
