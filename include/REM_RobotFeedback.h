...
static inline bool REM_RobotFeedback_get_needTimeStamp(REM_RobotFeedbackPayload *remrfp){
...
static inline void REM_RobotFeedback_set_fromBS(REM_RobotFeedbackPayload *remrfp, bool fromBS){
    remrfp->payload[2] = ((fromBS << 2) & 0b00000100) | (remrfp->payload[2] & 0b11111011);
}

static inline void REM_RobotFeedback_set_fromPC(REM_RobotFeedbackPayload *remrfp, bool fromPC){
    remrfp->payload[2] = ((fromPC << 1) & 0b00000010) | (remrfp->payload[2] & 0b11111101);
}

static inline void REM_RobotFeedback_set_needTimeStamp(REM_RobotFeedbackPayload *remrfp, bool needTimeStamp){
    remrfp->payload[2] = (needTimeStamp & 0b00000001) | (remrfp->payload[2] & 0b11111110);
}
...
static inline void encodeREM_RobotFeedback(REM_RobotFeedbackPayload *remrfp, REM_RobotFeedback *remrf){
    ...
    REM_RobotFeedback_set_needTimeStamp       (remrfp, remrf->needTimeStamp);
...
static inline void decodeREM_RobotFeedback(REM_RobotFeedback *remrf, REM_RobotFeedbackPayload *remrfp){
    ...
    remrf->needTimeStamp = REM_RobotFeedback_get_needTimeStamp(remrfp);
