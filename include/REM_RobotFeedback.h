...
-------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- -------- --111111 11111111 11111111 filler
*/
...
typedef struct _REM_RobotFeedback {
    ...
    uint32_t   filler              ; // integer [0, 4194303]         filler bits to have equal or more bytes than REM_RobotCommand
} REM_RobotFeedback;
...
static inline uint32_t REM_RobotFeedback_get_filler(REM_RobotFeedbackPayload *remrfp){
    return ((remrfp->payload[21] & 0b00111111) << 16) | ((remrfp->payload[22]) << 8) | ((remrfp->payload[23]));
}
...
static inline void REM_RobotFeedback_set_filler(REM_RobotFeedbackPayload *remrfp, uint32_t filler){
    remrfp->payload[21] = ((filler >> 16) & 0b00111111) | (remrfp->payload[21] & 0b11000000);
    remrfp->payload[22] = (filler >> 8);
    remrfp->payload[23] = filler;
}
