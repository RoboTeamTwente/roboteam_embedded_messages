...
// ================================ GETTERS ================================
static inline uint32_t REM_RobotAssuredPacket_get_packetType(REM_RobotAssuredPacketPayload *remrapp){
...
static inline uint64_t REM_RobotAssuredPacket_get_timestamp(REM_RobotAssuredPacketPayload *remrapp){
    return ((uint64_t) (remrapp->payload[4]) << 40) | ((uint64_t) (remrapp->payload[5]) << 32) | ((uint32_t) (remrapp->payload[6]) << 24) | ((remrapp->payload[7]) << 16) | ((remrapp->payload[8]) << 8) | ((remrapp->payload[9]));
}

static inline uint32_t REM_RobotAssuredPacket_get_payloadSize(REM_RobotAssuredPacketPayload *remrapp){
    return ((remrapp->payload[10]));
}

static inline uint32_t REM_RobotAssuredPacket_get_sequenceNumber(REM_RobotAssuredPacketPayload *remrapp){
    return ((remrapp->payload[11]));
}

static inline uint32_t REM_RobotAssuredPacket_get_messageLength(REM_RobotAssuredPacketPayload *remrapp){
    return ((remrapp->payload[12]));
}

// ================================ SETTERS ================================
static inline void REM_RobotAssuredPacket_set_packetType(REM_RobotAssuredPacketPayload *remrapp, uint32_t packetType){
    remrapp->payload[0] = packetType;
}
...
static inline void REM_RobotAssuredPacket_set_timestamp(REM_RobotAssuredPacketPayload *remrapp, uint64_t timestamp){
    remrapp->payload[4] = (timestamp >> 40);
    remrapp->payload[5] = (timestamp >> 32);
    remrapp->payload[6] = (timestamp >> 24);
    remrapp->payload[7] = (timestamp >> 16);
    remrapp->payload[8] = (timestamp >> 8);
    remrapp->payload[9] = timestamp;
}

static inline void REM_RobotAssuredPacket_set_payloadSize(REM_RobotAssuredPacketPayload *remrapp, uint32_t payloadSize){
    remrapp->payload[10] = payloadSize;
}
...
static inline void decodeREM_RobotAssuredPacket(REM_RobotAssuredPacket *remrap, REM_RobotAssuredPacketPayload *remrapp){
    remrap->packetType   = REM_RobotAssuredPacket_get_packetType(remrapp);
