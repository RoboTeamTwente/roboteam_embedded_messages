...
// ================================ GETTERS ================================
static inline uint32_t REM_RobotGetPIDGains_get_packetType(REM_RobotGetPIDGainsPayload *remrgpidgp){
...
static inline uint64_t REM_RobotGetPIDGains_get_timestamp(REM_RobotGetPIDGainsPayload *remrgpidgp){
    return ((uint64_t) (remrgpidgp->payload[4]) << 40) | ((uint64_t) (remrgpidgp->payload[5]) << 32) | ((uint32_t) (remrgpidgp->payload[6]) << 24) | ((remrgpidgp->payload[7]) << 16) | ((remrgpidgp->payload[8]) << 8) | ((remrgpidgp->payload[9]));
}

static inline uint32_t REM_RobotGetPIDGains_get_payloadSize(REM_RobotGetPIDGainsPayload *remrgpidgp){
    return ((remrgpidgp->payload[10]));
}

// ================================ SETTERS ================================
static inline void REM_RobotGetPIDGains_set_packetType(REM_RobotGetPIDGainsPayload *remrgpidgp, uint32_t packetType){
    remrgpidgp->payload[0] = packetType;
}
...
static inline void REM_RobotGetPIDGains_set_timestamp(REM_RobotGetPIDGainsPayload *remrgpidgp, uint64_t timestamp){
    remrgpidgp->payload[4] = (timestamp >> 40);
    remrgpidgp->payload[5] = (timestamp >> 32);
    remrgpidgp->payload[6] = (timestamp >> 24);
    remrgpidgp->payload[7] = (timestamp >> 16);
    remrgpidgp->payload[8] = (timestamp >> 8);
    remrgpidgp->payload[9] = timestamp;
}

static inline void REM_RobotGetPIDGains_set_payloadSize(REM_RobotGetPIDGainsPayload *remrgpidgp, uint32_t payloadSize){
    remrgpidgp->payload[10] = payloadSize;
}

// ================================ ENCODE ================================
static inline void encodeREM_RobotGetPIDGains(REM_RobotGetPIDGainsPayload *remrgpidgp, REM_RobotGetPIDGains *remrgpidg){
    REM_RobotGetPIDGains_set_packetType          (remrgpidgp, remrgpidg->packetType);
...
static inline void decodeREM_RobotGetPIDGains(REM_RobotGetPIDGains *remrgpidg, REM_RobotGetPIDGainsPayload *remrgpidgp){
    remrgpidg->packetType= REM_RobotGetPIDGains_get_packetType(remrgpidgp);
