...
// ================================ GETTERS ================================
static inline uint32_t REM_RobotMusicCommand_get_packetType(REM_RobotMusicCommandPayload *remrmcp){
...
static inline uint64_t REM_RobotMusicCommand_get_timestamp(REM_RobotMusicCommandPayload *remrmcp){
    return ((uint64_t) (remrmcp->payload[4]) << 40) | ((uint64_t) (remrmcp->payload[5]) << 32) | ((uint32_t) (remrmcp->payload[6]) << 24) | ((remrmcp->payload[7]) << 16) | ((remrmcp->payload[8]) << 8) | ((remrmcp->payload[9]));
}
...
static inline void decodeREM_RobotMusicCommand(REM_RobotMusicCommand *remrmc, REM_RobotMusicCommandPayload *remrmcp){
    remrmc->packetType   = REM_RobotMusicCommand_get_packetType(remrmcp);
