...
// ================================ GETTERS ================================
static inline uint32_t RobotCommand_get_header(RobotCommandPayload *rcp) { return ((rcp->payload[0])); }

static inline uint32_t RobotCommand_get_remVersion(RobotCommandPayload *rcp) { return ((rcp->payload[1] & 0b11110000) >> 4); }

static inline uint32_t RobotCommand_get_id(RobotCommandPayload *rcp) { return ((rcp->payload[1] & 0b00001111)); }

static inline uint32_t RobotCommand_get_messageId(RobotCommandPayload *rcp) { return ((rcp->payload[2] & 0b11110000) >> 4); }

static inline bool RobotCommand_get_doKick(RobotCommandPayload *rcp) { return (rcp->payload[2] & 0b00001000) > 0; }

static inline bool RobotCommand_get_doChip(RobotCommandPayload *rcp) { return (rcp->payload[2] & 0b00000100) > 0; }

static inline bool RobotCommand_get_doForce(RobotCommandPayload *rcp) { return (rcp->payload[2] & 0b00000010) > 0; }

static inline bool RobotCommand_get_useCameraAngle(RobotCommandPayload *rcp) { return (rcp->payload[2] & 0b00000001) > 0; }
...
static inline uint32_t RobotCommand_get_dribbler(RobotCommandPayload *rcp) { return ((rcp->payload[11] & 0b11100000) >> 5); }
...
static inline bool RobotCommand_get_angularControl(RobotCommandPayload *rcp) { return (rcp->payload[11] & 0b00000010) > 0; }

static inline bool RobotCommand_get_feedback(RobotCommandPayload *rcp) { return (rcp->payload[11] & 0b00000001) > 0; }

// ================================ SETTERS ================================
static inline void RobotCommand_set_header(RobotCommandPayload *rcp, uint32_t header) { rcp->payload[0] = header; }
...
static inline void RobotCommand_set_id(RobotCommandPayload *rcp, uint32_t id) { rcp->payload[1] = (id & 0b00001111) | (rcp->payload[1] & 0b11110000); }

static inline void RobotCommand_set_messageId(RobotCommandPayload *rcp, uint32_t messageId) { rcp->payload[2] = ((messageId << 4) & 0b11110000) | (rcp->payload[2] & 0b00001111); }

static inline void RobotCommand_set_doKick(RobotCommandPayload *rcp, bool doKick) { rcp->payload[2] = ((doKick << 3) & 0b00001000) | (rcp->payload[2] & 0b11110111); }

static inline void RobotCommand_set_doChip(RobotCommandPayload *rcp, bool doChip) { rcp->payload[2] = ((doChip << 2) & 0b00000100) | (rcp->payload[2] & 0b11111011); }

static inline void RobotCommand_set_doForce(RobotCommandPayload *rcp, bool doForce) { rcp->payload[2] = ((doForce << 1) & 0b00000010) | (rcp->payload[2] & 0b11111101); }
...
static inline void RobotCommand_set_dribbler(RobotCommandPayload *rcp, uint32_t dribbler) { rcp->payload[11] = ((dribbler << 5) & 0b11100000) | (rcp->payload[11] & 0b00011111); }
...
static inline void RobotCommand_set_feedback(RobotCommandPayload *rcp, bool feedback) { rcp->payload[11] = (feedback & 0b00000001) | (rcp->payload[11] & 0b11111110); }
