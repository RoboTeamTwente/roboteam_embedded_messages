...
static inline float RobotCommand_get_angularVelocity(RobotCommandPayload *rcp){
    uint32_t _angularVelocity = ((rcp->payload[9]) << 8) | ((rcp->payload[10]));
...
static inline float RobotCommand_get_cameraAngle(RobotCommandPayload *rcp){
    uint32_t _cameraAngle = ((rcp->payload[11]) << 8) | ((rcp->payload[12]));
...
static inline float RobotCommand_get_dribbler(RobotCommandPayload *rcp){
    uint32_t _dribbler = ((rcp->payload[13] & 0b11100000) >> 5);
...
static inline float RobotCommand_get_kickChipPower(RobotCommandPayload *rcp){
    uint32_t _kickChipPower = ((rcp->payload[13] & 0b00011100) >> 2);
...
static inline bool RobotCommand_get_angularControl(RobotCommandPayload *rcp){
    return (rcp->payload[13] & 0b00000010) > 0;
}

static inline bool RobotCommand_get_feedback(RobotCommandPayload *rcp){
    return (rcp->payload[13] & 0b00000001) > 0;
}
...
static inline void RobotCommand_set_angularVelocity(RobotCommandPayload *rcp, float angularVelocity){
    uint32_t _angularVelocity = (uint32_t)((angularVelocity +12.5663706143591725) / 0.0003835010487330);
    rcp->payload[9] = (_angularVelocity >> 8);
    rcp->payload[10] = _angularVelocity;
}
...
static inline void RobotCommand_set_cameraAngle(RobotCommandPayload *rcp, float cameraAngle){
    ...
    rcp->payload[11] = (_cameraAngle >> 8);
    rcp->payload[12] = _cameraAngle;
}
...
static inline void RobotCommand_set_dribbler(RobotCommandPayload *rcp, float dribbler){
    ...
    rcp->payload[13] = ((_dribbler << 5) & 0b11100000) | (rcp->payload[13] & 0b00011111);
}
...
static inline void RobotCommand_set_kickChipPower(RobotCommandPayload *rcp, float kickChipPower){
    ...
    rcp->payload[13] = ((_kickChipPower << 2) & 0b00011100) | (rcp->payload[13] & 0b11100011);
}

static inline void RobotCommand_set_angularControl(RobotCommandPayload *rcp, bool angularControl){
    rcp->payload[13] = ((angularControl << 1) & 0b00000010) | (rcp->payload[13] & 0b11111101);
}

static inline void RobotCommand_set_feedback(RobotCommandPayload *rcp, bool feedback){
    rcp->payload[13] = (feedback & 0b00000001) | (rcp->payload[13] & 0b11111110);
}
...
static inline void encodeRobotCommand(RobotCommandPayload *rcp, RobotCommand *rc){
    ...
    RobotCommand_set_angularVelocity     (rcp, rc->angularVelocity);
...
static inline void decodeRobotCommand(RobotCommand *rc, RobotCommandPayload *rcp){
    ...
    rc->angularVelocity  = RobotCommand_get_angularVelocity(rcp);
